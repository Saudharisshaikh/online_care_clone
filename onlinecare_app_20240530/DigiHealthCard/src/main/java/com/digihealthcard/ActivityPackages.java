...
import com.digihealthcard.adapter.PackageAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View.OnClickListener onClickListener = v -> {
            if(v.getId() == R.id.tvIndividual){
                ...
                tvIndividual.setTextColor(getResources().getColor(R.color.cardBackcolor));
                tvFamily.setBackgroundColor(getResources().getColor(R.color.cardBackcolor));
                ...
                tvIndividual.setBackgroundColor(getResources().getColor(R.color.cardBackcolor));
                ...
                tvFamily.setTextColor(getResources().getColor(R.color.cardBackcolor));
