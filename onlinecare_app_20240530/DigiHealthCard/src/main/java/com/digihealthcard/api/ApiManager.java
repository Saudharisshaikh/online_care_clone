package com.digihealthcard.api;
...
public class ApiManager {
	...
	public static final String COVACARD_BASE_URL = "https://digihealthcard.com/app/";//"https://digihealthcard.com/app/";//"https://onlinecare.com/covacard/app/";
	public static final String COVACARD_DEMO_URL = "https://covacard.com/demo/app/";
	...
	public static final String CHECK_USERNAME_AVAILABLITY = "patient/checkAvailability";
	...
	public static final String SAVE_CARD = "card/saveCard";
	public static final String GET_CARDS = "card/getCards";
	public static final String DELETE_CARD = "card/delete";
	public static final String SAVE_RESULT = "testresults/saveResult";
	public static final String GET_RESULT = "testresults/getResult";
	public static final String FETCH_EMAIL = "testresults/fetchemail";
	public static final String CARD_TYPES = "card/card_types";
	public static final String LABELS = "general/labels";
	public static final String CHECK_EXPIRY = "subscriptions/checkexpiry";
	public static final String GET_PACKAGES = "patient/getPackages";
	public static final String TEST_RESULT_DELETE = "testresults/delete";

	public static final String ID_CARD_TYPES = "idcards/card_types";
	public static final String SAVE_ID_CARD = "idcards/saveCard";
	public static final String GET_ID_CARDS = "idcards/getCards";
	public static final String DELETE_ID_CARD = "idcards/delete";

	public static final String BUY_WITH_CODE = "packages/check_package";
	public static final String GET_CARD = "card/getCard";
	public static final String GET_ID_CARD = "idcards/getCard";
	public static final String CANCEL_SUBSCRIPTION = "subscriptions/cancel_subscription";
	public static final String INVOICES = "payments/invoices";
	public static final String INAPP_PAY = "payments/inapp_pay";

	public static final String REQUEST_OTP_CODE = "otp_code/otp_request";
	public static final String OTP_VERIFY = "otp_code/verifyOtp";
	public static final String SIMPLE_OTP_VERIFY = "otp_code/simpleVerifyOtp";


	public static final String DEL_ACC_OTPREQUEST = "otp_code/delete_account_otp_request";
	public static final String DEL_ACC_OTP_VERIFY = "otp_code/verifyotp_delete_account";
	...
	public ApiManager(String api, String getOrPost, RequestParams params, ApiCallBack apiCallBack, Activity activity) {
		...
		//customURL = baseUrl+api;
		customURL = sharedPrefsHelper.get("baseURL", ApiManager.COVACARD_BASE_URL)+api;
	...
	public static void setupKeystores(AsyncHttpClient client){
		try {
