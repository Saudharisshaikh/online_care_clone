...
import com.app.omrandr.permission.PermissionsActivity;
import com.app.omrandr.permission.PermissionsChecker;
...
public class Login extends AppCompatActivity implements ApiCallBack{
	...
	public static final String CURRENT_APP = "omran_doctor";//by zohaib for Omran doc
	public static final String HOSPITAL_ID_EMCURA = "47";//Omran hosp id
