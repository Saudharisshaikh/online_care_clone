...
public abstract class BaseActivity extends AppCompatActivity implements OnRequestPermissionsResultCallback,
    ...
    protected void fetchAuthorization() {
        if (mAuthorization != null) {
            ...
            onAuthorizationFetched();
            DATA.print("-- use tokenization key true : key : "+mAuthorization);
        } else {
            DATA.print("-- fetch authorization : customer id : "+Settings.getCustomerId(this)+
                    " | Merchant ID : "+Settings.getMerchantAccountId(this));
            OnlineCare.getApiClient(this).getClientToken(Settings.getCustomerId(this),
