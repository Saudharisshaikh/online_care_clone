...
public class Settings {
    ...
    //Default keys in braintree demo app
    /*private static final String SANDBOX_TOKENIZATION_KEY = "sandbox_tmxhyf7d_dcpspy2brwdjr3qn";
    private static final String PRODUCTION_TOKENIZATION_KEY = "production_t2wns2y2_dfy45jdj3dxkmz5m";*/

    //Onlinecare Brantree key sir Jamals Accounts
    public static String SANDBOX_TOKENIZATION_KEY = "sandbox_q7bbvd24_wnf3kpg749p7td38";//onlinecare_newdesign
    public static String PRODUCTION_TOKENIZATION_KEY = "production_yk26dhjt_sz99zx39vjz5rt6x";//onlinecareus

    public static final int SANDBOX_ENVIRNMENT = 0, PRODUCTION_ENVIRNMENT = 1;
    ...
    public static void setVersion(Context context) {
        getPreferences(context).edit().putInt(VERSION, Settings.VERSION_CODE).apply();
    }
