...
public class GloabalSocket {
            ...
            activity.runOnUiThread(new Runnable() {
                ...
                public void run() {
					...
					try {
						...
						System.out.println("-- joinroom data: "+data.toString());
					} catch (Exception e) {
						e.printStackTrace();
					}*/
                    ...
                    for (Object o: args) {
                        System.out.println("-- onConnected: data: "+o.toString());
    ...
    public void emitSocket(JSONObject jsonData){
        ...
        System.out.println("-- emitSocket called activity: "+activity.getClass().getSimpleName());
    }
