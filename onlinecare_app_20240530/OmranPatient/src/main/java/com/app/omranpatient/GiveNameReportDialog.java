...
//http://www.cbuystore.com/onlineclinic/index.php/app/uploadReports
	...
	/*public void uploadFile(final Context context) {
	    final UploadRequest request = new UploadRequest(context, "1" , "http://www.cbuystore.com/onlineclinic/index.php/app/uploadReports");
           System.out.println("--url "+DATA.baseUrl+"uploadReports");
    	...
    	System.out.println("--online care report path: "+DATA.selectedReprtPath);
...
//	  request.addHeader("Content-Type", "application/x-www-form-urlencoded");
	    ...
	    if(DATA.isFromReportsFolder) {
	    	...
	    	System.out.println("--online care selected folder id: "+DATA.selectedReprtFoldrId);
	    	System.out.println("--online care selected file name: "+DATA.selectedReprtName);

	    	System.out.println("--online care from folder");
		    //and parameters
	    	...
	    	System.out.println("--online care from reports");
	    ...
	    try {
	    	...
	    	System.out.println("--exception in uploadreport");
	    	exc.printStackTrace();
	...
	public void onBackPressed() {
	 ...
	 public void uploadReport(String selectedReprtName) {
		 ...
		 try {
			 System.out.println("-- file path "+DATA.selectedReprtPath);
