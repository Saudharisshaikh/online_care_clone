...
import com.app.emcurauc.adapter.NearbyHospitalsAdapter;
import com.app.emcurauc.api.ApiManager;
import com.app.emcurauc.model.HospitalsBean;
...
public class MapActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (connection.isConnectedToInternet()) {
			getNearByDrs(DATA.stateFromLiveCare);
		} else {
...
//	                R.id.map)).getMap();
	...
	public void getNearByDrs(String state) {
	...
	public void getAllDrs() {
		...
		String requrl = DATA.baseUrl+"/alldoctors/";
		DATA.print("-- request " + requrl);
