package com.app.mhcsn_uc.adapter;
...
import com.app.mhcsn_uc.model.MessageBean;
...
//		filter(DATA.selectedDrId);
	...
	static class ViewHolder {
		...
		TextView tvMsgTextMe,tvMsgTimeMe,tvMsgNameMe,tvMsgTextOther,tvMsgTimeOther,tvMsgNameOther;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null) {
			...
			viewHolder.tvMsgNameMe = (TextView) convertView.findViewById(R.id.tvMsgNameMe);
			...
			viewHolder.tvMsgNameOther = (TextView) convertView.findViewById(R.id.tvMsgNameOther);
			...
			convertView.setTag(R.id.tvMsgNameMe, viewHolder.tvMsgNameMe);
			...
			convertView.setTag(R.id.tvMsgNameOther, viewHolder.tvMsgNameOther);
		...
		if (messageBeans.get(position).getFrom().equalsIgnoreCase("doctor") || messageBeans.get(position).getFrom().equalsIgnoreCase("specialist")) {
			...
			viewHolder.tvMsgNameOther.setVisibility(View.VISIBLE);
			viewHolder.tvMsgNameOther.setText(messageBeans.get(position).getFirst_name()+" "+messageBeans.get(position).getLast_name());
			viewHolder.tvMsgNameOther.setTag(messageBeans.get(position).getFirst_name()+" "+messageBeans.get(position).getLast_name());
			...
			viewHolder.tvMsgNameMe.setVisibility(View.VISIBLE);
			viewHolder.tvMsgNameMe.setText(prefs.getString("first_name", "")+" "+prefs.getString("last_name", ""));
			viewHolder.tvMsgNameMe.setTag(prefs.getString("first_name", "")+" "+prefs.getString("last_name", ""));
