...
public class BackgroundTaskJava extends Worker {
    ...
    public void callNotification() {
        ...
        fullScreenPendingIntent = PendingIntent.getActivity(getApplicationContext(), tempId, fullScreenIntent, PendingIntent.FLAG_IMMUTABLE);
       /* }
        else {
...
//        /*============================ Ahmer work end =================================*/
        ...
        Uri notifSoundUri = Uri.parse("android.resource://"+ getApplicationContext().getPackageName() +"/" + R.raw.incoming_call);
