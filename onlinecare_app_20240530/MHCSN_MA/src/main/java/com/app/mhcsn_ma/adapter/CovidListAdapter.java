...
import com.app.mhcsn_ma.ActivityCovidAssignDocList;
import com.app.mhcsn_ma.ActivityCovidFormList;
import com.app.mhcsn_ma.ActivityTcmDetails;
import com.app.mhcsn_ma.R;
import com.app.mhcsn_ma.model.CovidFormListBean;
import com.app.mhcsn_ma.model.MyAppointmentsModel;
...
public class CovidListAdapter extends ArrayAdapter<CovidFormListBean> {
	...
	static class ViewHolder {
		TextView tvPatientName, tvDate, tvViewForm,tvAction, tvCareAct, tvCall, tvMessage,tvAssignToProvider,tvResultStatus,tvSendResults,
				tvTestLocation,tvCheckedBy,tvAddVitals,tvRemove;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		/*viewHolder.cbSwabSendOut.setText(covidFormListBeans.get(position).swab_send_out.equalsIgnoreCase("1") ? "Yes": "No");
		viewHolder.cbInHouseSwab.setText(covidFormListBeans.get(position).in_house_swab.equalsIgnoreCase("1") ? "Yes": "No");
		viewHolder.cbStrepTest.setText(covidFormListBeans.get(position).strep_test.equalsIgnoreCase("1") ? "Yes": "No");
		viewHolder.cbRapidFlu.setText(covidFormListBeans.get(position).rapid_flu.equalsIgnoreCase("1") ? "Yes": "No");
		viewHolder.cbDnaFlu.setText(covidFormListBeans.get(position).dna_flu.equalsIgnoreCase("1") ? "Yes": "No");
		viewHolder.rbCulture.setText(covidFormListBeans.get(position).culture.equalsIgnoreCase("1") ? "Yes": "No");

		viewHolder.cbSwabSendOut.setChecked(covidFormListBeans.get(position).swab_send_out.equalsIgnoreCase("1"));
		viewHolder.cbInHouseSwab.setChecked(covidFormListBeans.get(position).in_house_swab.equalsIgnoreCase("1"));
		viewHolder.cbStrepTest.setChecked(covidFormListBeans.get(position).strep_test.equalsIgnoreCase("1"));
		viewHolder.cbRapidFlu.setChecked(covidFormListBeans.get(position).rapid_flu.equalsIgnoreCase("1"));
		viewHolder.cbDnaFlu.setChecked(covidFormListBeans.get(position).dna_flu.equalsIgnoreCase("1"));
		viewHolder.rbCulture.setChecked(covidFormListBeans.get(position).culture.equalsIgnoreCase("1"));*/

		//activity.getResources().getDrawable(R.drawable.ic_check_white_24dp)
