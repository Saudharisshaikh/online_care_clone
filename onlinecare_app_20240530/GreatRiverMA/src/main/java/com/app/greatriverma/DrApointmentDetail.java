...
public class DrApointmentDetail extends BaseActivity {
	...
	TextView tvPatientName,tvApptSymp,tvApptCond,tvApptDesc,tvApptDate,tvApptTime,tvApptStatus,tvApptPainBodyPart,tvApptPainSeverity,tvApptProvider;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tvApptProvider = findViewById(R.id.tvApptProvider);
		...
		tvApptProvider.setText(DATA.drAppointmentModel.dr_name);
