...
import com.app.greatriverma.adapter.DrAppointmentsAdapter;
...
import com.app.greatriverma.util.Database;
import com.app.greatriverma.util.GloabalMethods;
import com.app.greatriverma.util.SpinnerCustom;
...
//					msg = jsonObject.getString("msg");
    ...
    public void refferToAdmin(ArrayList<String> appointment_ids) {
        ...
        //DATA.print("--params in refferToAdmin "+params.toString());
        ...
        client.post(reqURL,params ,new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] response) {
                ...
                try{
                    ...
                    DATA.print("--responce in refferToAdmin: "+content);
