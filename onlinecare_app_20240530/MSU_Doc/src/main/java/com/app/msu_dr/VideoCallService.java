...
//
//		DATA.print("--online care videocallservice started...");
//
//		initChatService();
//		
...
////		}
//
//		DATA.print("--online care selected call user id: "+DATA.selectedUserQbid);
//
//
//		opponentUser.setId(Integer.parseInt(DATA.selectedUserQbid));
//
//		DATA.print("--online care in videocallscreen before callFriend qb id"+DATA.selectedUserQbid);
//
