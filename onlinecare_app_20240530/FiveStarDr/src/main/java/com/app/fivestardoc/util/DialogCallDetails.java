...
import com.app.fivestardoc.ActivityDischargeNotes;
import com.app.fivestardoc.ActivityTcmDetails;
import com.app.fivestardoc.DocToDoc;
import com.app.fivestardoc.R;
import com.app.fivestardoc.adapter.LabReportsAdapter;
import com.app.fivestardoc.adapter.NotesAdapter2;
...
public class DialogCallDetails implements ApiCallBack, DialogAddEncNoteFromCallHist.RefreshEncounterNotesInterface {
    ...
    public void initDetailsDialog(CallLogBean callLogBean) {
        ...
        Button btnLabReq = dialogCallDetails.findViewById(R.id.btnLabReq);
        Button BtnAddDischargeNotes = dialogCallDetails.findViewById(R.id.BtnAddDischargeNotes);
        ...
        btnrecall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (callLogBean.getCallto().equalsIgnoreCase("doctor")) {
                    ...
                    DATA.incommingCallId = callLogBean.getId();
        ...
        if (callLogBean.getCallto().equalsIgnoreCase("doctor")) {
            ...
            //Ahmer work
            BtnAddDischargeNotes.setOnClickListener(v -> {
                DATA.selectedUserCallId = callLogBean.getPatient_id();
                openActivity.open(ActivityDischargeNotes.class , false);
            });

            btnLabReq.setOnClickListener(v -> {
                DATA.selectedUserCallId = callLogBean.getPatient_id();
                getLabReports();
            });
            //end
