...
import com.app.fivestardoc.util.ChoosePictureDialog;
...
import com.app.fivestardoc.util.UploadImageCall;
...
//				upldImg.execute("");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etUpdateStateOfPractice = findViewById(R.id.etUpdateStateOfPractice);
        ...
        etUpdateStateOfPractice.setText(prefs.getString("stateOfPractice", ""));
...
//		UrlImageViewHelper.setUrlDrawable(imgChangeProfileImg, prefs.getString("id", ""), R.drawable.dummy_user_big);
        ...
        int genderID = 3;
        try {
            genderID = Integer.parseInt(prefs.getString("gender", "1"));
        } catch (Exception e) {
            e.printStackTrace();
        }
...
//	}
    ...
    public void updateProfileNoFinish() {
        ...
        String reqURL = DATA.baseUrl + "doctor/updateProfile";
