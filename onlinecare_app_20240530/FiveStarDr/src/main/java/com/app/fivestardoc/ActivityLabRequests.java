...
import com.app.fivestardoc.model.LabReqDetailsModel;
...
public class ActivityLabRequests extends BaseActivity {
    ...
    public void viewLabReq(String id , String patient_id)
    {
        RequestParams params = new RequestParams();
    ...
    public void fetchDataCallback(String httpstatus, String apiName, String content) {
            ...
            try {
                ...
                if (status.equalsIgnoreCase("success")) {
                    ...
                    for (int i = 0; i < data.length(); i++) {
                        ...
                        String resultId = data.getJSONObject(i).getString("result_id");
                        String doctor_id = data.getJSONObject(i).getString("doctor_id");
                        String patient_id = data.getJSONObject(i).getString("patient_id");

                        bean = new LabRequestModel(id, first_name, last_name, dateof , resultId , doctor_id , patient_id);
        ...
        else if (apiName.contains(ApiManager.VIEW_LAB_RESULT))
        {
            try {
                JSONObject jsonObject = new JSONObject(content);
                String status = jsonObject.getString("status");
