...
import com.app.msu_cp.ActivityFollowUps_4;
...
import com.app.msu_cp.fcm.MyFirebaseMessagingService;
...
import com.app.msu_cp.util.RingtonePlayer;
    ...
    class CountDownRunner implements Runnable{
        ...
        public void run() {
            while(!Thread.currentThread().isInterrupted()){
                try {
                    //DATA.print("countdown running from: "+activity.getClass().getSimpleName());
                    displayTimer();
                    Thread.sleep(1000);
