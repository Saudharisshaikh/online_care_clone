...
import com.app.msu_cp.adapters.VVReportImagesAdapter2;
import com.app.msu_cp.api.ApiManager;
import com.app.msu_cp.careplan.ActivityCarePlan;
import com.app.msu_cp.model.FollowupBean;
import com.app.msu_cp.reliance.ActivityProblemListNew;
import com.app.msu_cp.reliance.assessment.ActivityAdlForm;
import com.app.msu_cp.reliance.assessment.ActivityAdlList;
import com.app.msu_cp.reliance.assessment.ActivityAssessmentsSummary;
import com.app.msu_cp.reliance.assessment.ActivityDAST_Form;
import com.app.msu_cp.reliance.assessment.ActivityDastList;
import com.app.msu_cp.reliance.assessment.ActivityDietAssesForm;
import com.app.msu_cp.reliance.assessment.ActivityDietAssesList;
import com.app.msu_cp.reliance.assessment.ActivityOtEvaForm;
import com.app.msu_cp.reliance.assessment.ActivityOtEvaList;
import com.app.msu_cp.reliance.assessment.ActivityOtProfileForm;
import com.app.msu_cp.reliance.assessment.ActivityOtProfileList;
import com.app.msu_cp.reliance.assessment.ActivityPHQ_Form;
import com.app.msu_cp.reliance.assessment.ActivityPhqList;
import com.app.msu_cp.reliance.assessment.ActivitySDHSList;
import com.app.msu_cp.reliance.assessment.ActivitySDHS_Form;
import com.app.msu_cp.reliance.assessment.ActivitySelfMgtForm;
import com.app.msu_cp.reliance.assessment.ActivitySelfMgtList;
...
import com.app.msu_cp.reliance.careteam.ActivityCareTeam;
import com.app.msu_cp.reliance.counter.ActivityCounter;
...
import com.app.msu_cp.reliance.preschistory.ActivityPrescHistory;
import com.app.msu_cp.reliance.pt_reports.ReportFolders;
import com.app.msu_cp.reliance.therapist.ActivityTherapyNoteList;
...
public class ActivityTcmDetails extends BaseActivity {
    ...
    LinearLayout layReports,layVideoCall,layCareReview,laySoapNotes,layProgressNotes,layAssesments,layOtNotes,layMsg,layNEMT,
            layAddOTNotes,layCarePlan, layCounter,layIDTnotes,layCareTeam, layInstantConnect,layTherapyNotes,layBhealthAssess,layMedicationList;
    ...
    Button btnEditVV,btnEditPicturePt;
    ...
    protected void onResume() {
        ...
        if(DATA.isImageCaptured) {
            ...
            try {
               ...
               /* UploadPatientImageCall upldImg = new UploadPatientImageCall(activity);
                upldImg.execute("");*/
            ...
            DATA.loadImageFromURL(prefs.getString("imagePt", ""), R.drawable.icon_call_screen, imgSelPtImage);
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnEditPicturePt = findViewById(R.id.btnEditPicturePt);
        btnEditPicturePt.setOnClickListener(view ->
        {
            Intent intent = new Intent(activity, ChoosePictureDialog.class);
            intent.putExtra("isForProfilePicPt", true);
            startActivity(intent);
        });
        ...
        layTherapyNotes = findViewById(R.id.layTherapyNotes);
        layBhealthAssess = findViewById(R.id.layBhealthAssess);
        layMedicationList = findViewById(R.id.layMedicationList);
            ...
            public void onClick(View v) {
                switch (v.getId()) {
                    ...
                    case R.id.layInstantConnect:
                        ...
                        startActivity(intent);
                        break;
                    case R.id.layTherapyNotes:
                        openActivity.open(ActivityTherapyNoteList.class, false);
                        break;
                    case R.id.layBhealthAssess:
                        new GloabalMethods(activity).showWellnessOptionsDialog();
                        break;
                    case R.id.layMedicationList:
                        openActivity.open(ActivityMedicationList.class, false);
                        break;
                    default:
                        break;
                }
        ...
        layTherapyNotes.setOnClickListener(onClickListener);
        layBhealthAssess.setOnClickListener(onClickListener);
        layMedicationList.setOnClickListener(onClickListener);
    ...
    public void fetchDataCallback(String httpStatus, String apiName, String content) {
        if(apiName.contains(ApiManager.PATIENT_DETAIL)){
            try {
                ...
                String ptID = patient_data.getString("id");
                SharedPrefsHelper.getInstance().save("ptID" , ptID);
                ...
                if(!jsonObject.getString("virtual_visit").isEmpty()){
                    ...
                    btnEditVV.setVisibility(View.GONE);//VISIBLE - change to activate edit function
                }else {
        ...
        else if (apiName.equalsIgnoreCase(ApiManager.UPLOAD_IMG_PT)) {
            try {
                ...
                {
                    DATA.loadImageFromURL(jsonObject.getString("image"), R.drawable.icon_call_screen, imgSelPtImage);

                    SharedPreferences.Editor ed = prefs.edit();
                    ed.putString("imagePt",jsonObject.getString("image"));
                    ed.commit();
    ...
    private void UploadptImage() {
        RequestParams params = new RequestParams();
        params.put("patient_id",prefs.getString("ptID", "0"));
        try {
            params.put("image", new File(DATA.imagePath));
        } catch (FileNotFoundException e) {
            e.printStackTrace();
        }
        ApiManager apiManager = new ApiManager(ApiManager.UPLOAD_IMG_PT,"post",params,apiCallBack, activity);
        apiManager.loadURL();
    }
    ...
    public void showOptionsDialog(){
        ...
        Button btnMedSummary = dialogOptions.findViewById(R.id.btnMedSummary);

        btnMedSummary.setOnClickListener(v -> openActivity.open(ActivityMedicalSummary.class,false));
        ...
        btnSelPtProblemList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                openActivity.open(ActivityProblemListNew.class, false);
            }
        });
