...
import com.app.msu_cp.util.DialogPatientVV;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		viewHolder.imgCatIcon.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				if(position == images.size()){
					try {
						if(activity instanceof GetLiveCareForm){
							GetLiveCareForm.btnSelectImages.performClick();
						}else if(activity instanceof ActivityOTPT_Notes){
							ActivityOTPT_Notes.btnSelectImages.performClick();
						}else if(activity instanceof MainActivity && DialogPatientVV.btnSelectImages != null){
							DialogPatientVV.btnSelectImages.performClick();
						}
					}catch (Exception e){
						e.printStackTrace();
					}
