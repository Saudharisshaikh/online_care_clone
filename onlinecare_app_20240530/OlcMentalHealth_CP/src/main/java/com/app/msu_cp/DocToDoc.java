		...
		client.get(DATA.baseUrl+"getDoctorsByClinic", params, new AsyncHttpResponseHandler() {
			...
			public void onSuccess(int statusCode, Header[] headers, byte[] response) {
				...
				try{
					...
					DATA.print("--Response in getDoctorsByClinic: "+content);
...
//				refreshMenuItem.setActionView(null);
					...
					e.printStackTrace();
					DATA.print("-- responce onsuccess: getDoctorsByClinic, http status code: "+statusCode+" Byte responce: "+response);
					customToast.showToast(DATA.CMN_ERR_MSG,0,0);
				}
			}
			...
			public void onFailure(int statusCode, Header[] headers, byte[] errorResponse, Throwable e) {
				...
				try {
					...
					DATA.print("-- onfailure getDoctorsByClinic : "+content);
