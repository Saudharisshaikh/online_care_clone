...
public class ActivitySOAP_Pending extends BaseActivity implements ApiCallBack{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activity = ActivitySOAP_Pending.this;
        ...
        findViewById(R.id.filterLay).setVisibility(View.GONE);
    ...
    public void getData(){
        String date = "";
        if(!etSOAPDate.getText().toString().equalsIgnoreCase("Select Date")){
    ...
    public void getNotes(String search_doctor_id,String search_date) {
        ...
        ApiManager apiManager = new ApiManager(ApiManager.GET_PENDING_NOTES,"post",params,apiCallBack, activity);
        apiManager.loadURL();
    ...
    public void fetchDataCallback(String status, String apiName, String content) {
        if(apiName.equals(ApiManager.GET_PENDING_NOTES)){
            try {
                ...
                if (jsonArray.length() == 0) {
                    ...
                    NotesAdapter2.isPendingNotes = true;
                    NotesAdapter2 adapter = new NotesAdapter2(activity, notesBeans);
                    lvBilling.setAdapter(adapter);
                }
