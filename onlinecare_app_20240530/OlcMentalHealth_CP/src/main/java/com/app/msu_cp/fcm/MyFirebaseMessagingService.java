...
import com.app.msu_cp.ActivityRifills;
import com.app.msu_cp.BuildConfig;
import com.app.msu_cp.ConversationsActivity;
import com.app.msu_cp.DoctorsList;
import com.app.msu_cp.DrsAppointments;
...
import com.app.msu_cp.ShowGroupMessagePopup;
import com.app.msu_cp.ShowLiveCarePopup;
import com.app.msu_cp.ShowMessagePopupActivity;
import com.app.msu_cp.SupportMessagesActivity;
import com.app.msu_cp.VCallModule;
import com.app.msu_cp.ViewConversationActivity;
import com.app.msu_cp.model.ConversationBean;
import com.app.msu_cp.model.SupportMessageBean;
import com.app.msu_cp.reliance.therapist.ActivityReferedPatients;
import com.app.msu_cp.services.IncomingCallResponse;
import com.app.msu_cp.util.DATA;
import com.app.msu_cp.util.DialogPatientInfo;
import com.app.msu_cp.util.EasyAES;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void generateAction(String response,Context context) {
        ...
        try {
            ...
            if (jsonObject.has("response_type") && jsonObject.getString("response_type").equalsIgnoreCase("appointment_join")) {
            ...
            if (jsonObject.has("response_type") && jsonObject.getString("response_type").equalsIgnoreCase("group_message")) {
                ...
                if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
                    if(OnlineCareNurse.isAppInForground){
            ...
            if (data.has("status") && data.getString("status").equalsIgnoreCase("newpatient")) {
                ...
                Class<? extends Activity> aClass = LiveCare.class;
                if(data.has("message")){//doc assigned a pt from tcm cc
                    aClass = DoctorsList.class;
                }
                sendNotification(data.optString("message", "New patient added to your live care queue"), aClass);
            ...
            if (data.has("status") && data.getString("status").equalsIgnoreCase("referred_doctor")) {
                sendNotification(jsonObject.getJSONObject("data").getString("message"), ActivityReferedPatients.class);
                return;
            }
            ...
            if (response_type.equalsIgnoreCase("outgoing")) {
                ...
                if (incoming_call_status == 1) {
                    ...
                    if (jsonObject.has("first_name") && jsonObject.has("last_name")) {// this should be
                        // added in
                        // service
