...
public class RvPainAdapter extends RecyclerView.Adapter<RvPainAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.ivPSEmoji.setImageResource(GetLiveCareForm.painSevEmojies[position]);
        holder.tvPSLbl.setText(GetLiveCareForm.painSeverity[position]);
    ...
    public int getItemCount() {
        return GetLiveCareForm.painSeverity.length;
    }
}
