...
import com.app.msu_cp.adapters.RefillsAdapter;
		...
		client.get(DATA.baseUrl+"/refillRequests/"+prefs.getString("id", ""), new AsyncHttpResponseHandler() {
			...
			public void onSuccess(int statusCode, Header[] headers, byte[] response) {
				...
				try{
					...
					e.printStackTrace();
					DATA.print("-- responce onsuccess: refillRequests, http status code: "+statusCode+" Byte responce: "+response);
			...
			public void onFailure(int statusCode, Header[] headers, byte[] errorResponse, Throwable e) {
				...
				try {
					...
					DATA.print("--onfail refillRequests: " +content);
