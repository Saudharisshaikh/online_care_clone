...
//        	temp = null;
		...
		client.post(DATA.baseUrl+"/searchAllDoctors/", params, new AsyncHttpResponseHandler() {
			...
			public void onSuccess(int statusCode, Header[] headers, byte[] response) {
				...
				try{
					...
					DATA.print("--responce in searchAllDoctors: "+content);
					...
					e.printStackTrace();
					DATA.print("-- responce onsuccess: searchAllDoctors, http status code: "+statusCode+" Byte responce: "+response);
			...
			public void onFailure(int statusCode, Header[] headers, byte[] errorResponse, Throwable e) {
				...
				try {
					...
					DATA.print("--responce in failure searchAllDoctors: "+content);
	...
	public void nurseDoctorsSearch(String user_type,String zipcode) {
		...
		DATA.print("-- params in nurseDoctorsSearch: "+params.toString());
		/*if (etZipcode.getText().toString().isEmpty()) {
		...
		client.post(DATA.baseUrl+"/nurseDoctorsSearch/", params, new AsyncHttpResponseHandler() {
			...
			public void onSuccess(int statusCode, Header[] headers, byte[] response) {
				...
				try{
					...
					DATA.print("--responce in nurseDoctorsSearch: "+content);
					...
					e.printStackTrace();
					DATA.print("-- responce onsuccess: nurseDoctorsSearch, http status code: "+statusCode+" Byte responce: "+response);
					customToast.showToast(DATA.CMN_ERR_MSG,0,0);
				}
			}
			...
			public void onFailure(int statusCode, Header[] headers, byte[] errorResponse, Throwable e) {
				...
				try {
					String content = new String(errorResponse);
					DATA.print("--responce in failure nurseDoctorsSearch: "+content);
					new GloabalMethods(activity).checkLogin(content, statusCode);
					customToast.showToast(DATA.CMN_ERR_MSG,0,0);
	...
	public void fetchDataCallback(String status, String apiName, String content) {
		if(apiName.equalsIgnoreCase(ApiManager.MY_DOCTORS)){
			...
			DATA.allDoctors = parseMyDoc(content);
	...
	public static ArrayList<DoctorsModel> parseMyDoc(String content){
    ...
    /*private void referToSpecialist(String liveCheckupId , String specialistId) {
		...
		client.get(DATA.baseUrl+"referToSpecialist", params, new AsyncHttpResponseHandler() {
			...
			public void onFailure(int statusCode, Throwable error,
				...
				DATA.print("--on fail referToSpecialist: "+content);
			...
			public void onSuccess(String response) {
				DATA.print("--online care response in refer patients to secialist: "+response);
