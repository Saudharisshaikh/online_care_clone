...
public class ActivitySOAP extends BaseActivity implements ApiCallBack, ObservableScrollViewCallbacks {
    ...
    ObservableListView lvBilling;
    LinearLayout filterLay;
    TextView tvNoNotes;
    EditText etSOAPDate;
    Spinner spSOAPDoc;
    public static int addSoapFlag = 1;//1 = virtual visit data, 2 = new soapnote
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etSOAPDate = findViewById(R.id.etSOAPDate);
        spSOAPDoc = findViewById(R.id.spSOAPDoc);
        lvBilling = findViewById(R.id.lvBilling);
        lvBilling.setScrollViewCallbacks(this);
    ...
    private void hideViews() {
        filterLay.animate().translationY(-filterLay.getHeight()).setInterpolator(new AccelerateInterpolator(2));
        ...
        /*if(bottomBarView.getVisibility() == View.VISIBLE){
            ...
            bottomBarView.startAnimation(bottomDown);
    ...
    private void showViews() {
        ...
        filterLay.animate().translationY(0).setInterpolator(new DecelerateInterpolator(2));

        /*if(bottomBarView.getVisibility() != View.VISIBLE){
            Animation bottomUp = AnimationUtils.loadAnimation(activity, R.anim.bottom_up);
            bottomBarView.startAnimation(bottomUp);
            ...
            try {
                ...
                if (jsonArray.length() == 0) {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        String patient_id = jsonArray.getJSONObject(i).getString("note_patient_id");//DATA.selectedUserCallId;//jsonArray.getJSONObject(i).getString("patient_id");
                    ...
                    NotesAdapter2.isPendingNotes = false;
                    NotesAdapter2 adapter = new NotesAdapter2(activity, notesBeans);
                    lvBilling.setAdapter(adapter);
                }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.getItem(0).setTitle("Add SOAP Notes");
