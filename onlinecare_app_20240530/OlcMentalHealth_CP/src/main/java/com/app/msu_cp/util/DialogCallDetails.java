...
import com.app.msu_cp.adapters.NotesAdapter2;
import com.app.msu_cp.api.ApiCallBack;
import com.app.msu_cp.api.ApiManager;
import com.app.msu_cp.model.CallLogBean;
import com.app.msu_cp.model.DoctorsModel;
import com.app.msu_cp.model.NotesBean;
...
public class DialogCallDetails implements ApiCallBack, DialogAddEncNoteFromCallHist.RefreshEncounterNotesInterface {
    ...
    public void initDetailsDialog(CallLogBean callLogBean) {
        ...
        btnrecall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
				...
				finish();*/
                    ...
                    //new GloabalMethods(activity).getPatientDetails();//false   - No need  - CP have no presc btn after call
        ...
        //this was lagacy code done in CP app - Commit after new call history section copied from doc
        /*btnrecall.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View arg0) {

                if (callLogBean.getCallto1().equalsIgnoreCase("patients")) {
                    DATA.incomingCall = false;
                    DATA.isFromDocToDoc = false;
                    DATA.selectedUserCallId = callLogBean.getPatient_id();
                    DATA.selectedUserCallName = callLogBean.getFirst_name()+" "+callLogBean.getLast_name();
					...
					*//*Intent myIntent = new Intent(getBaseContext(), MainActivity.class);
                    ...
                    activity.startActivity(myIntent);
                    activity.finish();
                } else if (callLogBean.getCallto1().equalsIgnoreCase("doctor")){
                ...
                }else if (callLogBean.getCallto1().equalsIgnoreCase("specialist")){
                    DATA.incomingCall = false;
                    DATA.isFromDocToDoc = true;
                    DATA.selectedDrName = callLogBean.getFirst_name()+" "+callLogBean.getLast_name();
                    DATA.selectedDrId = callLogBean.getPatient_id();
        ...
        if (callLogBean.getCallto().equalsIgnoreCase("doctor")) {
            ...
            layB2.setVisibility(View.GONE);//no need for CP
