...
import static com.app.msu_cp.util.DATA.SIGNUP_URL;
import static com.app.msu_cp.util.DATA.baseUrl;
...
public class ApiManager {
	...
	public static final String BHEALTH_GET_ATTACH_SURVEY = "bhealth/getAttachSurvery";
	public static final String BHEALTH_GET_THERAPY_NOTES = "bhealth/gettherapynotes";
	public static final String BHEALTH_GET_ATTACH_SURVEY_APPTMNT = "bhealth/getAppointmentSurvery";
	...
	public static final String MEDICATION_LIST = "medications/getlisting";
	public static final String MEDICATION_ADD = "medications/add";
	public static final String MEDICATION_SORT = "medications/sortMeds";
    public static final String MEDICATION_STOP = "medications/stop_medications";
    public static final String MEDICATION_UPDATE = "medications/update";
    public static final String MEDICATION_RENEW = "medications/renew";
    public static final String MEDICATION_PAST_LIST =  "medications/pastlisting";

	public static final String GET_SURGERIES =  "medicalhistory/getSurgeries";
	public static final String SAVE_SURGERIES =  "medicalhistory/saveSurgery";
	public static final String DELETE_SURGERIES =  "medicalhistory/deleteSurgery";
	public static final String SAVE_ICD_CODES =  "patient/saveicdcode";
	public static final String GET_MED_SUMMARY =  "medicalhistory/get_medical_summaries";
	public static final String SAVE_MED_SUMMARY =  "medicalhistory/save_medical_summary";
	public static final String DELETE_MED_SUMMARY =  "medicalhistory/delete_medical_summary";

	public static final String UPLOAD_IMG_PT = "cp/upload_patient_img";
