			...
			public void onClick(View v) {
				AlertDialog alertDialog =
						new AlertDialog.Builder(activity, R.style.CustomAlertDialogTheme).setTitle("Confirm")
								.setMessage("Are you sure? Do you want to delete this diagnosis?")
								.setPositiveButton("Yes Delete", new DialogInterface.OnClickListener() {
									@Override
									public void onClick(DialogInterface dialog, int which) {
										diagnosisList.remove(position);
										notifyDataSetChanged();
										if(activity instanceof ActivityProblemListNew){
											((ActivityProblemListNew)activity).tvNoData.setVisibility(diagnosisList.isEmpty() ? View.VISIBLE:View.GONE);
										}
									}
								})
