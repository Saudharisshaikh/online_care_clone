...
import com.app.onlinecare.oovoosample.Main.MainActivity;
import com.app.onlinecare.util.AsyncFiveSeconds;
					...
					public void run() {
						...
						try {
							...
							if(isNetworkConnected()) {
								...
								System.out.println("--online care incoming call service running");
