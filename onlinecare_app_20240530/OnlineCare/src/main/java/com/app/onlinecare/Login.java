...
import com.app.onlinecare.permission.PermissionsActivity;
import com.app.onlinecare.permission.PermissionsChecker;
...
public class Login extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, ApiCallBack{
	...
	public static String HOSPITAL_ID_EMCURA = "6";//1=demo//6 = onlinecare//"13";//Emcura hosp id
