package com.app.OnlineCareTDC_Pt.permission;
...
public class PermissionsActivity extends AppCompatActivity {
    ...
    private void requestPermissions(String... permissions) {
        if(prefs.getBoolean("isFirstTimeRequest", true)){
            ...
            //System.out.println("permission GMGM 1");
        }
        else {
            ...
            if(shouldShowReqRationale){
                //System.out.println("permission GMGM 2");
                ActivityCompat.requestPermissions(this, permissions, PERMISSION_REQUEST_CODE);
            }else {
                openAppSettings();
                //System.out.println("permission GMGM 3");
            }
        }
    }
