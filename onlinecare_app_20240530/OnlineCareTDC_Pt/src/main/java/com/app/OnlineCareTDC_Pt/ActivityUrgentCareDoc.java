...
import com.app.OnlineCareTDC_Pt.adapter.UrgentCareAdapter;
...
public class ActivityUrgentCareDoc extends BaseActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //hide lvDoctorUrgentcare and add gridview accoroding to TDC design - date 10-05-2022
    ...
    public void fetchDataCallback(String status, String apiName, String content) {
        if(apiName.equals(ApiManager.GET_URGENT_CARES)){
            try {
                ...
                gvDoctorsUrgentCare.setAdapter(urgentCareAdapter);
            ...
            try {
                ...
                customSnakeBar.showToast("No doctors available in the urgent care center");
                    ...
                    gvDoctorsUrgentCare.setAdapter(new LvLivecareDoctorsAdapter(activity , latLongBeansList));
                }
