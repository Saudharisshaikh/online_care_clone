...
import static com.app.OnlineCareTDC_Pt.util.ActionSheetPopup.REQUEST_SELECT_FROM_GALLERY_LIVECARE;
...
public class GetLiveCare extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                if (DATA.allConditions != null) {
                    ...
                    for (int i = 0; i < DATA.allConditions.size(); i++) {
                        ...
                        if (conditionsModel.isEnglish) {
                            ...
                            condArr[i] = DATA.allConditions.get(i).langSpanishCondName;
                        }
                    }
            ...
            public void onClick(View v) {
                ...
                if (checkInternetConnection.isConnectedToInternet()) {
                    ...
                    for (int i = 0; i < checked.size(); i++) {
                        ...
                        if (checked.valueAt(i)) {
                            ...
                            if (conditionsModel.isEnglish) {
                                ...
                                DATA.print("-- selectedConditionId english " + selectedConditionId);
                            } else if (!conditionsModel.isEnglish) {
                                selectedConditionId = selectedConditionId + ((List<ConditionsModel>) gvConditionNew.getTag()).get(position1).langSpanishCondName + ", ";
                                DATA.print("-- selectedConditionId spanish " + selectedConditionId);
                            }
                        }
                    }
                    if (c == 0) {
                    ...
                    if (selectedSympId.equals("0") //|| selectedConditionId.equals("0")  etLiveZipCode.getText().toString().isEmpty() ||
                            || selectedSympId.equals("") || selectedConditionId.equals("") || userState.equals("")) {
        ...
        gvSymptomNew.setOnItemClickListener((adapterView, view, i, l) -> {
