...
import com.app.OnlineCareTDC_Pt.ActivityDoctorInfo;
...
import com.app.OnlineCareTDC_Pt.model.NearbyDoctorBean;
...
public class LvLivecareDoctorsAdapter extends ArrayAdapter<NearbyDoctorBean> {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null) {
			...
			viewHolder.ivDr = (ImageView) convertView.findViewById(R.id.ivDr);
			...
			viewHolder.laybtnRequest = convertView.findViewById(R.id.laybtnRequest);
		...
		DATA.loadImageFromURL(allLatlongs.get(position).getImage(), R.drawable.doctor, viewHolder.ivDr);
		...
		//Ahmer moved btn request code moved to click on layout after tdc changed design
		viewHolder.laybtnRequest.setOnClickListener(view ->
		{
			NearbyDoctorBean bean = allLatlongs.get(position);
			DATA.doctorIdForLiveCare = bean.getId();
			activity.startActivity(new Intent(activity,PaymentLiveCare.class));
