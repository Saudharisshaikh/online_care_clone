...
package com.app.OnlineCareTDC_Pt.fcm;
...
import com.app.OnlineCareTDC_Pt.ActivityEliveAssignedPopup;
import com.app.OnlineCareTDC_Pt.ActivityLabRequests;
import com.app.OnlineCareTDC_Pt.BuildConfig;
import com.app.OnlineCareTDC_Pt.ConversationsActivity;
import com.app.OnlineCareTDC_Pt.GetLiveCare;
import com.app.OnlineCareTDC_Pt.LiveCareWaitingArea;
import com.app.OnlineCareTDC_Pt.Login;
import com.app.OnlineCareTDC_Pt.MainActivityNew;
import com.app.OnlineCareTDC_Pt.MyAppointments;
import com.app.OnlineCareTDC_Pt.OnlineCare;
import com.app.OnlineCareTDC_Pt.R;
import com.app.OnlineCareTDC_Pt.ShowGroupMessagePopup;
import com.app.OnlineCareTDC_Pt.ShowMessagePopupActivity;
import com.app.OnlineCareTDC_Pt.SupportMessagesActivity;
import com.app.OnlineCareTDC_Pt.VCallModule;
import com.app.OnlineCareTDC_Pt.ViewConversationActivity;
import com.app.OnlineCareTDC_Pt.model.ConversationBean;
import com.app.OnlineCareTDC_Pt.model.SupportMessageBean;
import com.app.OnlineCareTDC_Pt.util.DATA;
import com.app.OnlineCareTDC_Pt.util.EasyAES;
import com.app.OnlineCareTDC_Pt.util.IncomingCallResponse;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void handleIntent(Intent intent) {
        ...
        if (bundle != null) {
            for (String key : bundle.keySet()) {
                ...
                System.out.println("-- GMGM - FCM - onHandleIntent : "+"Key: " + key + " Value: " + value);

                //System.out.println("-- GMGM - Obj type : "+value.getClass().getName());


                try {
                    JSONObject jsonObject1 = new JSONObject(String.valueOf(bundle.get("message")));
                    System.out.println("GMGM 4 : Message JSON : "+jsonObject1);
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getData().size() > 0) {
            System.out.println("GMGM -onMessageReceived - Message data payload: " + remoteMessage.getData());
...
//                }
                ...
                SharedPrefsHelper.getInstance().save("folder_name" , folder_name);
                        ...
                        */
                        ...
                        if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
                            if(OnlineCare.isAppInForground){
                                ...
                                i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                                startActivity(i);
                                DATA.print("if work callNotification");
                            }else {
                                //callNotification();
                                //if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
                                DATA.print("else workmanager callNotification");
                                ...
                                //}
                                /*else {
                                    DATA.print("else work callNotification");
                                    callNotification();
                                }*/
                            }
                        }else {
...
//        notificationView.setOnClickPendingIntent(R.id.btnRejectCall, callDeclinePendingIntent);
        ...
        DATA.print("-- startForeground start old work by GM for call");
