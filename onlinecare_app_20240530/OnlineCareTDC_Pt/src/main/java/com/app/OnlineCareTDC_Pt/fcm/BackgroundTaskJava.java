...
//                        .setContentText("New incoming video call from "+DATA.incomingCallerName)
                        ...
                        .setSound(notifSoundUri , AudioManager.STREAM_RING)
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            //channel.setSound(notifSoundUri,new  AudioAttributes.Builder().setUsage(AudioAttributes.USAGE_NOTIFICATION_RINGTONE).build());
