...
import com.app.OnlineCareTDC_Pt.AfterCallDialog;
...
import com.app.OnlineCareTDC_Pt.fcm.MyFirebaseMessagingService;
...
import com.app.OnlineCareTDC_Pt.util.RingtonePlayer;
...
//        //==============end===============
    ...
    public void initVideoCallActivity() {
            ...
            callDisconnectBroadcast = new BroadcastReceiver() {
                ...
                public void onReceive(Context context, Intent intent) {
                    ...
                    if (MyFirebaseMessagingService.callRejectStatus == true) {
                        ...
                        DATA.print("-- callDisconnectBroadcast GM GM ");
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                            finishAndRemoveTask();
                            //Ahmer add this code for remove call screen from background 14/02/2023
                        } else {
                            finish();
                        }
        ...
        btnConnectToConsult.setOnClickListener(vCallModule.getConnectBtnListener(Utils.getNumRemotePeers()));
