...
import static io.agora.openlive.Constants.AGORA_ACCESS_TOKEN;
import static io.agora.openlive.Constants.AGORA_APP_ID;
import static io.agora.openlive.Constants.AGORA_UID;
...
import com.app.fivestaruc.AfterCallDialog;
...
import com.app.fivestaruc.fcm.MyFirebaseMessagingService;
...
import com.app.fivestaruc.util.RingtonePlayer;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("-- msgFromNotifications " + getIntent().hasExtra("fromNotificationcallAccept"));

        //Ahmer comment this code for temperory purpose 16-05-2020
        //==================ahmer work start from here======================
//        if (getIntent().hasExtra("fromNotificationcallAccept")) {
...
//            mMediaPlayer.setAudioStreamType(AudioManager.STREAM_RING);//STREAM_MUSIC
...
//        };
    ...
    {
        String RequestUrl = DATA.baseUrl+"agora/getToken";

        DATA.print("-- request " + RequestUrl);

        AsyncHttpClient client = new AsyncHttpClient();

        RequestParams params = new RequestParams();
        params.put("channel_name",  sg.com.temasys.skylink.sdk.sampleapp.Constants.ROOM_NAME_MULTI);

        DATA.print("-- params " + params);
        ...
        client.post(RequestUrl, params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                try {
                    ...
                    AGORA_ACCESS_TOKEN = jsonObject.getString("token");
                    AGORA_UID = jsonObject.getInt("uid");
                    AGORA_APP_ID = jsonObject.getString("appId");

                    DATA.print("-- AGORA_ACCESS_TOKEN ==  " + AGORA_ACCESS_TOKEN);
                    DATA.print("-- AGORA_UID ==  " + AGORA_UID);
                    DATA.print("-- AGORA_APP_ID ==  " + AGORA_APP_ID);
                    resetLayoutAndForward();
