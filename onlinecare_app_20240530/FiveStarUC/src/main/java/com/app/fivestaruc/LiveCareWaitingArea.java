...
import static com.app.fivestaruc.api.ApiManager.shouldShowLoader;
...
public class LiveCareWaitingArea extends BaseActivity {
	...
	String hrs = "", minutes = "";
	Button btnFillForm,btnAddPrimaryCare,btnUpdateSymptoms,btnExitUC;//btnCheckheartbeat
	...
	Button btnPharmacy;
	TextView tvSelPharmacy, tvLiveCareWaitMsg;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tvLiveCareWaitMsg = findViewById(R.id.tvLiveCareWaitMsg);
...
//				}else
		...
		btnUpdateSymptoms = findViewById(R.id.btnUpdateSymptoms);
...
//						.setMessage("Are you sure? Do you want to cancel your urgent care request?")
		...
		if(! TextUtils.isEmpty(prefsDataStr)){
			try {
				...
				if(getSupportActionBar() != null){
					getSupportActionBar().setTitle(jsonObject.optString("elivecareheader", DATA.LIVECARE_WAITING_ROOM_TITTLE));
				}
				tvLiveCareWaitMsg.setText(jsonObject.optString("averagewatingtimemsg", DATA.LIVECARE_WAITING_ROOM_MSG));
...
//		return hours+" hours, "+minutes+" minutes";
	...
	public void fetchDataCallback(String httpStatus, String apiName, String content) {
		...
		if(apiName.contains(ApiManager.GET_WAITING_PATIENTS)){
			...
			try {
				...
				JSONObject patients = jsonObject.getJSONObject("patients");
				...
				if(status.equals("1") || status.equals("") || status.equals("2")) {
					...
					//avtTimeMillis =  (yourNum * 600000);//300000 milis = 5 minutes, 600000 = 10 minutes, 60,000 = 1 Minute
					int over_timing = jsonObject.optInt("over_timing", 10);//This is from API
	...
	//Ahmer's code for create cancel uc reason dialog
