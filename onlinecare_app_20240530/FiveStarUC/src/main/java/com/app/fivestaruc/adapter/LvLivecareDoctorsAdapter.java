...
import com.app.fivestaruc.ActivityCheckInsurance;
import com.app.fivestaruc.ActivityDoctorInfo;
import com.app.fivestaruc.ActivityUrgentCareDoc;
import com.app.fivestaruc.MapActivity;
...
public class LvLivecareDoctorsAdapter extends ArrayAdapter<NearbyDoctorBean> {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		viewHolder.tvDrName.setText(allLatlongs.get(position).getTitle()+" "+allLatlongs.get(position).getFirst_name()+" "+allLatlongs.get(position).getLast_name());
		//viewHolder.imgCatIcon.setImageResource(DATA.allCategories.get(position).catIcon);


		viewHolder.tvDrName.setTag(allLatlongs.get(position).getTitle()+" "+allLatlongs.get(position).getFirst_name()+" "+allLatlongs.get(position).getLast_name());
		...
		viewHolder.btnRequest.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				activity.startActivity(new Intent(activity, ActivityCheckInsurance.class));
				activity.finish();
		...
		viewHolder.tvDrDesignation.setText("FiveStars Physician");
	...
	public void filter(String filterText) {
		...
		DATA.print("-- allLatlongsOrig size: "+allLatlongsOrig.size());
