...
import static com.app.fivestaruc.GetLiveCare.painSeverity;
...
import com.app.fivestaruc.util.DatePickerFragment2;
		...
		btnSbmtSymptom.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(zipcode.isEmpty()) {
					...
					DoctorsList.zipcodeForApptmnt =  DATA.stateFromAptment; //etZipCode.getText().toString();
