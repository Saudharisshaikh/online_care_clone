...
//
//import com.app.onlinecare.VideoCallService.LocalBinder;
//import com.app.onlinecare.services.MessageReceiverService;
//
...
//		this.ctx = ctx;
//		
//	    Intent intent = new Intent(ctx, MessageReceiverService.class);
