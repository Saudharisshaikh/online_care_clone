	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnApnmntStartVideoCall.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				System.out.println("--online care qb_username on videocallscreen: "+prefs.getString("qb_username", ""));
				System.out.println("--online care qb_password on videocallscreen: "+prefs.getString("qb_password", ""));
