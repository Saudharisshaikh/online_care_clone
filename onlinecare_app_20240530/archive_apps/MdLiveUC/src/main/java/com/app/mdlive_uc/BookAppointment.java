...
import com.app.mdlive_uc.model.PayerBean;
import com.app.mdlive_uc.paypal.PaymentLiveCare;
...
import com.app.mdlive_uc.util.LiveCareInsurance;
import com.app.mdlive_uc.util.LiveCareInsuranceCardhelper;
import com.app.mdlive_uc.util.LiveCareInsuranceInterface;
...
import static com.app.mdlive_uc.util.SharedPrefsHelper.PKG_AMOUNT;
...
public class BookAppointment extends BaseActivity {
	...
	private void bookAppointmentCall() {
		...
		/*System.out.println("--online care selected report ids: "+DATA.selectedReportIdsForApntmt);
		System.out.println("dr_schedule_id: "+DATA.selectedDayIdForAppointment);*/
		System.out.println("--param in bookAppointment "+params.toString());
		...
		client.get(DATA.baseUrl+"bookAppointment", params, new AsyncHttpResponseHandler() {
			...
			public void onFailure(int statusCode, Header[] headers, byte[] errorResponse, Throwable e) {
				...
				try {
					...
					System.out.println("-- on failure API: bookAppointment : "+content);
			...
			public void onSuccess(int statusCode, Header[] headers, byte[] response) {
				...
				try{
					...
					System.out.println("--online care response in api bookAppointment : "+content);
					try {
						...
						System.out.println("--Exception in bookAppointment : "+e);
						e.printStackTrace();
						customToast.showToast(DATA.JSON_ERROR_MSG,0,0);
					}
				}catch (Exception e){
					e.printStackTrace();
					System.out.println("-- responce onsuccess: bookAppointment , http status code: "+statusCode+" Byte responce: "+response);
					customToast.showToast(DATA.CMN_ERR_MSG,0,0);
				}
			}
		});
	...
	private void directAppointment() {
		...
		/*System.out.println("--online care selected report ids: "+DATA.selectedReportIdsForApntmt);
		System.out.println("dr_schedule_id: "+DATA.selectedDayIdForAppointment);*/
		System.out.println("--param in patient/directAppointment "+params.toString());
		...
		client.get(DATA.baseUrl+"patient/directAppointment", params, new AsyncHttpResponseHandler() {
			...
			public void onFailure(int statusCode, Header[] headers, byte[] errorResponse, Throwable e) {
				...
				try {
					String content = new String(errorResponse);
					System.out.println("-- on failure API: patient/directAppointment : "+content);
					new GloabalMethods(activity).checkLogin(content);
					customToast.showToast(DATA.CMN_ERR_MSG,0,0);
			...
			public void onSuccess(int statusCode, Header[] headers, byte[] response) {
				...
				try{
					...
					System.out.println("--online care response in api patient/directAppointment: "+content);
					try {
						jsonObject = new JSONObject(content);
						...
						System.out.println("--Exception in patient/directAppointment : "+e);
						e.printStackTrace();
						customToast.showToast(DATA.JSON_ERROR_MSG,0,0);
					}
					...
					e.printStackTrace();
					System.out.println("-- responce onsuccess: patient/directAppointment, http status code: "+statusCode+" Byte responce: "+response);
					customToast.showToast(DATA.CMN_ERR_MSG,0,0);
				}
			}
		});
		...
		client.get(DATA.baseUrl+"getPayers", new AsyncHttpResponseHandler() {
			...
			public void onSuccess(int statusCode, Header[] headers, byte[] response) {
				...
				try{
					...
					e.printStackTrace();
					System.out.println("-- responce onsuccess: getPayers, http status code: "+statusCode+" Byte responce: "+response);
					customToast.showToast(DATA.CMN_ERR_MSG,0,0);
				}
			}
