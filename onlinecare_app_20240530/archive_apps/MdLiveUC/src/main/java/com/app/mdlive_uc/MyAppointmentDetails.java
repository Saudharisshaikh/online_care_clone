...
//
//		}
		System.out.println("--slot id "+aptSlotID);
	...
	public void cancelAppointment(String appointmentId) {
		...
		System.out.println("--in cancelAppointment  params: "+params.toString());
		...
		client.post(DATA.baseUrl+"/cancelAppointment", params, new AsyncHttpResponseHandler() {
			...
			public void onSuccess(int statusCode, Header[] headers, byte[] response) {
				...
				try{
					...
					System.out.println("--reaponce in cancelAppointment "+content);
					...
					e.printStackTrace();
					System.out.println("-- responce onsuccess: cancelAppointment, http status code: "+statusCode+" Byte responce: "+response);
			...
			public void onFailure(int statusCode, Header[] headers, byte[] errorResponse, Throwable e) {
				...
				try {
					...
					System.out.println("--onFailure in cancelAppointment "+content);
