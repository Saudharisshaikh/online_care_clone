...
import com.app.mdlive_uc.adapter.SelecReportsAdapter;
		...
		client.get(DATA.baseUrl+"getReports", params, new AsyncHttpResponseHandler() {
			...
			public void onSuccess(int statusCode, Header[] headers, byte[] response) {
				...
				try{
					...
					System.out.println("--online care response in api getReports : "+content);
					...
					e.printStackTrace();
					System.out.println("-- responce onsuccess: getReports, http status code: "+statusCode+" Byte responce: "+response);
			...
			public void onFailure(int statusCode, Header[] headers, byte[] errorResponse, Throwable e) {
				...
				try {
					...
					System.out.println("-- getReports on failure : "+content);
