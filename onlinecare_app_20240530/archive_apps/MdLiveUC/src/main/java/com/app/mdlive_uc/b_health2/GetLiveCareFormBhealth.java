...
import com.app.mdlive_uc.SelectReports;
import com.app.mdlive_uc.adapter.RvBodyPartAdapter;
import com.app.mdlive_uc.adapter.RvPainAdapter;
import com.app.mdlive_uc.adapter.VVReportImagesAdapter;
import com.app.mdlive_uc.api.ApiCallBack;
import com.app.mdlive_uc.api.ApiManager;
import com.app.mdlive_uc.b_health.assessment.ActivityDAST_Form;
import com.app.mdlive_uc.b_health.assessment.ActivityPHQ_Form;
import com.app.mdlive_uc.b_health.assessment.new_assesment.ActivityOCD_Form;
import com.app.mdlive_uc.b_health.assessment.new_assesment.ActivityStressQues_Form;
import com.app.mdlive_uc.model.ConditionsModel;
import com.app.mdlive_uc.model.SymptomsModel;
import com.app.mdlive_uc.util.ActionSheetPopup;
import com.app.mdlive_uc.util.CheckInternetConnection;
import com.app.mdlive_uc.util.CustomToast;
import com.app.mdlive_uc.util.DATA;
import com.app.mdlive_uc.util.Database;
import com.app.mdlive_uc.util.ExpandableHeightGridView;
import com.app.mdlive_uc.util.GloabalMethods;
import com.app.mdlive_uc.util.HideShowKeypad;
import com.app.mdlive_uc.util.OpenActivity;
import com.app.mdlive_uc.util.RecyclerItemClickListener;
...
public class GetLiveCareFormBhealth extends BaseActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		RadioButton tvDepression = findViewById(R.id.tvDepression);
		RadioButton tvAnxietyHealth = findViewById(R.id.tvAnxietyHealth);
		RadioButton tvStress = findViewById(R.id.tvStress);
		RadioButton tvPanicAttack = findViewById(R.id.tvPanicAttack);
		RadioButton tvInsomnia = findViewById(R.id.tvInsomnia);
		RadioButton tvFocusConc = findViewById(R.id.tvFocusConc);

		RadioButton tvOCD = findViewById(R.id.tvOCD);
		RadioButton tvScoff = findViewById(R.id.tvScoff);
		RadioButton tvDAST = findViewById(R.id.tvDAST);
			...
			public void onClick(View view) {
				...
				switch (view.getId()){
					case R.id.tvDepression:
						//if(tvDepression.isChecked()){tvDepression.setChecked(false);return;}
						//showAskDepDialog(1);
						//showAskDepDialog(7);
					...
					case R.id.tvAnxietyHealth:
						//if(tvAnxietyHealth.isChecked()){tvAnxietyHealth.setChecked(false);return;}
						//showAskDepDialog(8);
						GloabalMethods.isFromGetLiveCare = true;
						...
						break;
					case R.id.tvStress:
						//if(tvStress.isChecked()){tvStress.setChecked(false);return;}
						//showAskDepDialog(6);
						GloabalMethods.isFromGetLiveCare = true;
					...
					case R.id.tvPanicAttack:
						//if(tvPanicAttack.isChecked()){tvPanicAttack.setChecked(false);return;}
						//showAskDepDialog( 4);
						GloabalMethods.isFromGetLiveCare = true;
					...
					case R.id.tvInsomnia:
						//if(tvInsomnia.isChecked()){tvInsomnia.setChecked(false);return;}
						customToast.showToast("This section is under development",0,0);
						break;
					case R.id.tvFocusConc:
						//if(tvFocusConc.isChecked()){tvFocusConc.setChecked(false);return;}
						//showAskDepDialog( 3);
						GloabalMethods.isFromGetLiveCare = true;
						...
						break;
					case R.id.tvOCD:
						//if(tvOCD.isChecked()){tvOCD.setChecked(false);return;}
						//showAskDepDialog( 2);
						GloabalMethods.isFromGetLiveCare = true;
						...
						break;
					case R.id.tvScoff:
						//if(tvScoff.isChecked()){tvScoff.setChecked(false);return;}
						//showAskDepDialog( 5);
						GloabalMethods.isFromGetLiveCare = true;
						...
						break;
					case R.id.tvDAST:
						//if(tvDAST.isChecked()){tvDAST.setChecked(false);return;}
						//showAskDepDialog(9);
						GloabalMethods.isFromGetLiveCare = true;
