...
import com.app.mdlive_uc.adapter.SupportMessageAdapter;
...
public class SupportMessagesActivity extends BaseActivity {
	...
	public void sendCoordinatormessage(final String message_text) {
		...
		System.out.println("-- params in sendCoordinatormessage: "+params.toString());
		...
		client.post(DATA.baseUrl+"sendCoordinatormessage", params, new AsyncHttpResponseHandler() {
			...
			public void onSuccess(int statusCode, Header[] headers, byte[] response) {
				...
				try{
					...
					System.out.println("--reaponce in sendCoordinatormessage "+content);
					...
					e.printStackTrace();
					System.out.println("-- responce onsuccess: sendCoordinatormessage, http status code: "+statusCode+" Byte responce: "+response);
			...
			public void onFailure(int statusCode, Header[] headers, byte[] errorResponse, Throwable e) {
				...
				try {
					...
					System.out.println("--onfail sendCoordinatormessage " +content);
