...
*/
    ...
    public void donate(
        ...
        System.out.println("-- params in saveDonation: "+params.toString());
        ...
        client.post(DATA.baseUrl+"/saveDonation/"+patient_id,params ,new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] response) {
                ...
                try{
                    ...
                    System.out.println("-- responce in saveDonation: "+content);
                    customToast.showToast("Your donation has been sent successfully",0,1);
                    finish();
                }catch (Exception e){
                    e.printStackTrace();
                    System.out.println("-- responce onsuccess: saveDonation, http status code: "+statusCode+" Byte responce: "+response);
            ...
            public void onFailure(int statusCode, Header[] headers, byte[] errorResponse, Throwable e) {
                ...
                try {
                    ...
                    System.out.println("--responce in failure saveDonation: "+content);
