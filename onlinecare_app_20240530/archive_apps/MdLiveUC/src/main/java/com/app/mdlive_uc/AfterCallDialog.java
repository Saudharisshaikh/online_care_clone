		...
		client.post(DATA.baseUrl+"saveRating/",params, new AsyncHttpResponseHandler() {
			...
			public void onSuccess(int statusCode, Header[] headers, byte[] response) {
				...
				try{
					...
					System.out.println("--online care response in saveRating: "+content);
...
//				}
					...
					e.printStackTrace();
					System.out.println("-- responce onsuccess: saveRating, http status code: "+statusCode+" Byte responce: "+response);
