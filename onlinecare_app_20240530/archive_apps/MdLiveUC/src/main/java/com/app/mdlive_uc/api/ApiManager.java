...
import static com.app.mdlive_uc.util.DATA.SIGNUP_URL;
import static com.app.mdlive_uc.util.DATA.baseUrl;
...
public class ApiManager {
	...
	//this api is for mdslive app getlivecre doc list acc to companies/nusrsing homes
	public static final String PATIENT_COMPANIES_DOC = "doctor/patientCompaniesDoctors/";
