...
import com.app.mdlive_cp.model.MessageBean;
import com.app.mdlive_cp.util.DATA;
import com.mikhaellopez.circularimageview.CircularImageView;

import java.util.ArrayList;

public class MessageAdapterForSpecialist extends ArrayAdapter<MessageBean> {

	Activity activity;
	ArrayList<MessageBean> messageBeans;
	SharedPreferences prefs;

	public MessageAdapterForSpecialist(Activity activity , ArrayList<MessageBean> messageBeans) {
...
//		filter(DATA.selectedDrId);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (! messageBeans.get(position).getPatient_id().equalsIgnoreCase(prefs.getString("id", ""))) {
