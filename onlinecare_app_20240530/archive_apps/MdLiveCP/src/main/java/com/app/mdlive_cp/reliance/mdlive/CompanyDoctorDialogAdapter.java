...
public class CompanyDoctorDialogAdapter extends ArrayAdapter<CompanyDoctorBean> {

	Activity activity;
	ArrayList<CompanyDoctorBean> companyDoctorBeans, companyDoctorBeansOrig;
	//CustomToast customToast;

	public CompanyDoctorDialogAdapter(Activity activity, ArrayList<CompanyDoctorBean> companyDoctorBeans) {
		super(activity, R.layout.lv_companydoctor_row_dialog, companyDoctorBeans);
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null) {
			...
			convertView = layoutInflater.inflate(R.layout.lv_companydoctor_row_dialog, null);
			...
			viewHolder.cbSelectDoc = (CheckBox) convertView.findViewById(R.id.cbSelectDoc);
			...
			convertView.setTag(R.id.cbSelectDoc, viewHolder.cbSelectDoc);
		...
		viewHolder.cbSelectDoc.setChecked(companyDoctorBeans.get(position).isSelected);
	...
	public void filter(String filterText) {
		...
		try {
			...
			System.out.println("---doctorsModelsOrg size: "+companyDoctorBeansOrig.size());
