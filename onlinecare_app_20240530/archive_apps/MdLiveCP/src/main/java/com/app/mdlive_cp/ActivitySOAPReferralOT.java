...
public class ActivitySOAPReferralOT extends AppCompatActivity implements ApiCallBack{
    ...
    //note: this activity is for OT/PT to view approved dme referrals requested in OT/PT Notes
    ...
    protected void onResume() {
        ...
        ApiManager apiManager = new ApiManager(ApiManager.CAREPROVIDER_OT_REFERRALS,"post",params,apiCallBack, activity);
        apiManager.loadURL();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.tabOptions).setVisibility(View.GONE);//tab bar not needed
    ...
    public void fetchDataCallback(String status, String apiName, String content) {
        if(apiName.equalsIgnoreCase(ApiManager.CAREPROVIDER_OT_REFERRALS)){
            try {
                //soapReferralBeen = new ArrayList<>();
