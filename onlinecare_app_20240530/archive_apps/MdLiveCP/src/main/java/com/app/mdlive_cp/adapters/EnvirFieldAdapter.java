...
import com.app.mdlive_cp.ActivityEnvirForm;
import com.app.mdlive_cp.R;
import com.app.mdlive_cp.model.EnvirFieldBean;
...
public class EnvirFieldAdapter extends ArrayAdapter<EnvirFieldBean> {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if(activity instanceof ActivityEnvirForm){
			boolean clickAble = !((ActivityEnvirForm) activity).isReadOnly;
			...
			viewHolder.radioNA.setClickable(clickAble);
			viewHolder.radioNA.setLongClickable(clickAble);
		}
