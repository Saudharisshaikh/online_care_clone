...
import com.app.mdlive_cp.adapters.OTNotesAdapter;
import com.app.mdlive_cp.api.ApiCallBack;
import com.app.mdlive_cp.api.ApiManager;
import com.app.mdlive_cp.model.OTNoteBean;
...
public class ActivityViewOTNotes extends AppCompatActivity implements ApiCallBack {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("OT/PT Notes");
        ...
        btnToolbar.setText("Add OT/PT Notes");
    ...
    /*public void getotnotes() {
        ...
        client.post(DATA.baseUrl+"doctor/getotnotes", params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, String content) {
                ...
                System.out.println("--reaponce in getotnotes"+content);
            ...
            public void onFailure(Throwable error, String content) {
                DATA.dismissLoaderDefault();
                System.out.println("--onfail getotnotes" +content);
