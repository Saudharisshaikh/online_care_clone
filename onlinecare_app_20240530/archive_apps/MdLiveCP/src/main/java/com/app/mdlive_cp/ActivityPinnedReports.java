...
import com.app.mdlive_cp.adapters.ReportsPinedAdapter;
import com.app.mdlive_cp.api.ApiManager;
import com.app.mdlive_cp.model.FileBean;
import com.app.mdlive_cp.model.FolderBean;
...
public class ActivityPinnedReports extends AppCompatActivity {
    ...
    public void patient_folders_files() {
        ...
        System.out.println("-- URL in patient_folders_files : "+reqURL);
        System.out.println("-- params in patient_folders_files: "+params.toString());
        ...
        client.post(reqURL,params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] response) {
                ...
                try{
                    ...
                    System.out.println("--reaponce in patient_folders_files "+content);
                    ...
                    e.printStackTrace();
                    System.out.println("-- responce onsuccess: patient_folders_files, http status code: "+statusCode+" Byte responce: "+response);
            ...
            public void onFailure(int statusCode, Header[] headers, byte[] errorResponse, Throwable e) {
                ...
                try {
                    ...
                    System.out.println("--onfail patient_folders_files " +content);
