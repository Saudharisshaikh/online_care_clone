...
import com.app.mdlive_cp.model.DoctorBean;
import com.app.mdlive_cp.reliance.ActivityCompany;
import com.app.mdlive_cp.reliance.greatlakes.ActivityMyPatients;
import com.app.mdlive_cp.reliance.mdlive.ActivityCompanyDoctors;
import com.app.mdlive_cp.reliance.mdlive.CompanyDoctorBean;
import com.app.mdlive_cp.reliance.mdlive.CompanyDoctorExpListAdapter;
import com.app.mdlive_cp.reliance.mdlive.DialogCompanyDoctors;
        ...
        btnSubmitSignup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isFromMyDoc){
                    ...
                    //note : removed multi doc selection from mdlive and added only nursing home id
    ...
    public void parseDocData(String content){
        ...
        try {
            ...
            if(doctorBeans != null){
                ...
                System.out.println("-- doctorBeans is null: "+doctorBeans);
            }
    ...
    public void setupMultiDocField(){
        for (int i = 0; i < DialogCompanyDoctors.companyDoctorBeansSelected.size(); i++) {
            if(! isProviderAlreadyAdded(DialogCompanyDoctors.companyDoctorBeansSelected.get(i))){
                ...
                System.out.println("-- Provider Alredy added ! : "+DialogCompanyDoctors.companyDoctorBeansSelected.get(i).first_name);
            }
        }
