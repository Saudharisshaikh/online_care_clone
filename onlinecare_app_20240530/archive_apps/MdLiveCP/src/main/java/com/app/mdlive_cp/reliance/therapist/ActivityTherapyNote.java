...
public class ActivityTherapyNote extends BaseActivity {
    ...
    Button btnSwitchGoalInput,btnDiagAdd,btnDiagSelectAllApply,btnTherapist,btnPsychiatrist,btnSubmit,btnNotNow;
    @Override
    ...
    private void submitForm(){
        ...
        if(etNewGoal.getVisibility() == View.GONE){
                        ...
                        try {
                            ...
                            for (int j = 0; j < icdCodeBeansToSubmit.size(); j++) {
                                if(icdCodeBeansToSubmit.get(j).code.equalsIgnoreCase(icdCodeBean.code)){
                                    System.out.println("-- code already added : "+icdCodeBean.code);
                                    added = true;
                                    break;
                                }
                            }
