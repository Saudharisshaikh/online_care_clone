package com.app.mdlive_cp.reliance.preschistory;
                ...
                if(!prescHistoryBeans.isEmpty()){
                    try {
                        ...
                        e.printStackTrace();
                            ...
                            System.out.println("-- total pages: "+totalPages+" , page : "+page);
            ...
            try {
                ...
                /*if(medicine.length() == 0){
                    ...
                    if(prescHistoryBeansAPI != null){
                        ...
                        System.out.println("-- beansToRemove size: "+beansToRemove.size()+ "  isRemoved : "+isRemoved);
