...
import com.app.mdlive_cp.ActivityCallLogs;
...
import static com.app.mdlive_cp.R.id.tvBillingSubjective;
...
public class NotesAdapter2 extends ArrayAdapter<NotesBean> {
	...
	public static boolean isPendingNotes = false;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		//this block is closed b/c its doc app flow - after copy soap - encounter screens and call details dialog from doc app
		...
		if(activity instanceof ActivityCallLogs || activity instanceof AfterCallDialog || activity instanceof ActivityTelemedicineServices){
