...
import com.app.mdlive_cp.adapters.DmeRefAdapter;
import com.app.mdlive_cp.adapters.HomecareAdapter;
import com.app.mdlive_cp.adapters.ViewSkilledNursingAdapter;
...
public class ActivitySOAPReferral extends AppCompatActivity implements ApiCallBack{
    ...
    protected void onResume() {
        ...
        ApiManager apiManager = new ApiManager(ApiManager.CAREPROVIDER_APPROVED_REFERRALS,"post",params,apiCallBack, activity);
        apiManager.loadURL();
    ...
    public void fetchDataCallback(String status, String apiName, String content) {
        if(apiName.equalsIgnoreCase(ApiManager.CAREPROVIDER_APPROVED_REFERRALS)){
            try {
                //soapReferralBeen = new ArrayList<>();
