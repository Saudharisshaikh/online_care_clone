...
import com.app.mdlive_cp.adapters.FollowupAdapter3;
        ...
        client.post(DATA.baseUrl+"createfollowup", params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] response) {
                ...
                try{
                    ...
                    System.out.println("--reaponce in createfollowup: "+content);
                    ...
                    e.printStackTrace();
                    System.out.println("-- responce onsuccess: createfollowup, http status code: "+statusCode+" Byte responce: "+response);
