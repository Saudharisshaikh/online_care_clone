...
import com.app.mdlive_cp.adapters.LvDoctorsAdapter;
import com.app.mdlive_cp.adapters.NurseAdapter;
import com.app.mdlive_cp.api.ApiCallBack;
import com.app.mdlive_cp.api.ApiManager;
import com.app.mdlive_cp.model.CallParticipant;
import com.app.mdlive_cp.model.DoctorsModel;
import com.app.mdlive_cp.model.NurseBean;
...
public class VCallModule implements ApiCallBack{
    ...
    public void disconnectOutgoingCall(String patient_id) {
        ...
        System.out.println("--params in disconnectOutgoingCall "+params.toString());
		 /* if (DATA.isFromDocToDoc){
			  params.put("doctor_id", patient_id);
			  params.put("type", "doctor");
			  params.put("message", "disconnected");
        ...
        client.post(DATA.baseUrl+"/sendpush", params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] response) {
                ...
                try{
                    ...
                    System.out.println("--reaponce in disconnectOutgoingCall "+content);
                    try {
                        activity.finish();
                    } catch (Exception e) {
                    ...
                    e.printStackTrace();
                    System.out.println("-- responce onsuccess: sendpush, http status code: "+statusCode+" Byte responce: "+response);
            ...
            public void onFailure(int statusCode, Header[] headers, byte[] errorResponse, Throwable e) {
                ...
                try {
                    ...
                    System.out.println("--onFailure in disconnectOutgoingCall "+content);
    ...
    public void emscall(final boolean isThreeWay) {
        ...
        System.out.println("-- params in emscall: "+params.toString()+" isThreeWay: "+isThreeWay);
    ...
    public void find_nurse(String keyword,String patient_id,String patient_category) {
        ...
        System.out.println("-- params in find_nurse: "+params.toString());
        ...
        client.post(DATA.baseUrl+"find_nurse", params, new AsyncHttpResponseHandler() {
            ...
            public void onFailure(int statusCode, Header[] headers, byte[] errorResponse, Throwable e) {
                ...
                try {
                    String content = new String(errorResponse);
                    System.out.println("--onfail find_nurse " +content);
                    new GloabalMethods(activity).checkLogin(content);
                    customToast.showToast(DATA.CMN_ERR_MSG,0,0);
    ...
    public void callFromSpecialist() {
        ...
        System.out.println("-- params in callFromSpecialist: "+params.toString());
        ...
        client.get(DATA.baseUrl+"callFromSpecialist", params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] response) {
                ...
                try{
                    ...
                    System.out.println("--Response in callFromSpecialist : "+content);
                    ...
                    try {
                        ...
                        System.out.println("-- Exception in callFromSpecialist: "+e);
                        e.printStackTrace();
                        customToast.showToast(DATA.JSON_ERROR_MSG,0,0);
                    }
                }catch (Exception e){
                    e.printStackTrace();
                    System.out.println("-- responce onsuccess: callFromSpecialist, http status code: "+statusCode+" Byte responce: "+response);
                    customToast.showToast(DATA.CMN_ERR_MSG,0,0);
                }
            }
            ...
            public void onFailure(int statusCode, Header[] headers, byte[] errorResponse, Throwable e) {
                ...
                try {
                    String content = new String(errorResponse);
                    System.out.println("-- onfailure callFromSpecialist: "+content);
                    new GloabalMethods(activity).checkLogin(content);
                    customToast.showToast(DATA.CMN_ERR_MSG,0,0);
    ...
    /*public void emscallThreeWay() {
        ...
        client.post(DATA.baseUrl+"ems/emscall", params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, String content) {
                DATA.dismissLoaderDefault();
                System.out.println("--reaponce in emscall: "+content);
            ...
            public void onFailure(Throwable error, String content) {
                DATA.dismissLoaderDefault();
                System.out.println("--onfail createfollowup: " +content);
