...
public class HomecareAdapter extends ArrayAdapter<SoapReferralBean> {
	...
	public HomecareAdapter(Activity activity , ArrayList<SoapReferralBean> soapReferralBeens) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(!soapReferralBeens.get(position).homecare_referral.isEmpty()){
			try {
				JSONObject jsonObject = new JSONObject(soapReferralBeens.get(position).homecare_referral);
		...
		viewHolder.tvSoapRefStatus.setText("Status: "+soapReferralBeens.get(position).homecare_status);
