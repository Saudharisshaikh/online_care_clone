...
public class PresscriptionsActivity extends BaseActivity {
	...
	public void getPresscriptions() {
		...
		System.out.println("-- params in getPrescriptions: "+params.toString());
		...
		client.post(DATA.baseUrl+"/getPrescriptions",params ,new AsyncHttpResponseHandler() {
			...
			public void onSuccess(int statusCode, Header[] headers, byte[] response) {
				...
				try{
					...
					System.out.println("--responce in getPresscriptions: "+content);
					...
					e.printStackTrace();
					System.out.println("-- responce onsuccess: getPrescriptions, http status code: "+statusCode+" Byte responce: "+response);
			...
			public void onFailure(int statusCode, Header[] headers, byte[] errorResponse, Throwable e) {
				...
				try {
					...
					System.out.println("--responce in failure getPrescriptions: "+content);
