...
import com.app.mdlive_cp.FallRiskForm;
import com.app.mdlive_cp.R;
import com.app.mdlive_cp.model.FallRiskFieldBean;
...
public class FallRiskFieldAdapter extends ArrayAdapter<FallRiskFieldBean> {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if(activity instanceof FallRiskForm){
			boolean clickAble = !((FallRiskForm) activity).isReadOnly;
