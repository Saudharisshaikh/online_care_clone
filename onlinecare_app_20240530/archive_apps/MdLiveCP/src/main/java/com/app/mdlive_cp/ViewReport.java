...
import com.app.mdlive_cp.adapters.ViewReportsAdapter;
...
public class ViewReport extends AppCompatActivity {
	...
	public void getPatientReports() {
		...
		System.out.println("-- URL in getPatientReports: "+reqURL);
		...
		client.get(reqURL, new AsyncHttpResponseHandler() {
			...
			public void onSuccess(int statusCode, Header[] headers, byte[] response) {
				...
				try{
					...
					System.out.println("--reaponce in getPatientReports: "+content);
					try {
					...
					e.printStackTrace();
					System.out.println("-- responce onsuccess: getPatientReports, http status code: "+statusCode+" Byte responce: "+response);
			...
			public void onFailure(int statusCode, Header[] headers, byte[] errorResponse, Throwable e) {
				...
				try {
					...
					System.out.println("--onfail getPatientReports: " +content);
