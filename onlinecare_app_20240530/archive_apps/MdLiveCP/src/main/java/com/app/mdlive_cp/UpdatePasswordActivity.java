...
public class UpdatePasswordActivity extends BaseActivity {
	...
	public void updatePassword(String currentPass, String newPass, String confirmPass) {
		...
		System.out.println("-- params in changedoctorPassword: "+params.toString());
		...
		client.post(reqURL, params, new AsyncHttpResponseHandler() {
			...
			public void onSuccess(int statusCode, Header[] headers, byte[] response) {
				...
				try{
					...
					System.out.println("--responce in changedoctorPassword: " + content);
					try {
					...
					e.printStackTrace();
					System.out.println("-- responce onsuccess: changedoctorPassword, http status code: "+statusCode+" Byte responce: "+response);
			...
			public void onFailure(int statusCode, Header[] headers, byte[] errorResponse, Throwable e) {
				...
				try {
					...
					System.out.println("--responce in failure changedoctorPassword: " + content);
					showMessageBox(activity, "Error", DATA.CMN_ERR_MSG);
