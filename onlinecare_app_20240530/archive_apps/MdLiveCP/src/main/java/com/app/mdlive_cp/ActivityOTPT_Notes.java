...
May 11 18:26:11 iPhone Care Provider[376] <Warning>: Success -- sharedManager: {
    ...
    public void addotnotes(String ot_adl,String ot_bp,String ot_date,String ot_dmeneed,String ot_hr,String ot_iadl,
        ...
        System.out.println("-- params in addotnotes: "+params.toString());
        ...
        client.post(DATA.baseUrl+"doctor/addotnotes", params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] response) {
                ...
                try{
                    ...
                    System.out.println("--reaponce in addotnotes"+content);
                    ...
                    e.printStackTrace();
                    System.out.println("-- responce onsuccess: addotnotes, http status code: "+statusCode+" Byte responce: "+response);
            ...
            public void onFailure(int statusCode, Header[] headers, byte[] errorResponse, Throwable e) {
                ...
                try {
                    ...
                    System.out.println("--onfail addotnotes" +content);
