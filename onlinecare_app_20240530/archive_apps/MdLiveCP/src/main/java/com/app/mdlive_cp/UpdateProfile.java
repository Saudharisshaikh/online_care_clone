...
import com.app.mdlive_cp.model.StateBean;
import com.app.mdlive_cp.util.ChoosePictureDialog;
...
import com.app.mdlive_cp.util.UploadImageCall;
...
//	}
	...
	public void updateProfileNoFinish() {
		...
		System.out.println("-- params in updateProfile: "+params.toString());
		...
		client.get(DATA.baseUrl+"updateProfile", params, new AsyncHttpResponseHandler() {
			...
			public void onSuccess(int statusCode, Header[] headers, byte[] response) {
				...
				try{
					...
					System.out.println("-- Response in updateProfile : "+content);
...
//						DATA.isImageCaptured = false;
						...
						System.out.println("-- Exception in updateProfile: "+e);
						e.printStackTrace();
					...
					e.printStackTrace();
					System.out.println("-- responce onsuccess: updateProfile, http status code: "+statusCode+" Byte responce: "+response);
			...
			public void onFailure(int statusCode, Header[] headers, byte[] errorResponse, Throwable e) {
				...
				try {
					...
					System.out.println("-- onfailure updateProfile: "+content);
