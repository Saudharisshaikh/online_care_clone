...
import com.app.mdlive_cp.adapters.SupportMessageAdapter;
...
public class SupportMessagesActivity extends AppCompatActivity {
	...
	public static final String COORDINATOR_MESSAGE = BuildConfig.APPLICATION_ID+".coordinator_message";
	
	@Override
	protected void onStart() {
		registerReceiver(supportMsgBroadcast, new IntentFilter(SupportMessagesActivity.COORDINATOR_MESSAGE));
		super.onStart();
	}
