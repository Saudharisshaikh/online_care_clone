...
public class VVReportImagesAdapter2 extends ArrayAdapter<String> {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		/*Glide.with(activity)
				...
				.placeholder(com.darsh.multipleimageselect.R.drawable.image_placeholder).into(viewHolder.imgCatIcon);*/

		if(imagesArr.get(position).endsWith(".pdf")){
			viewHolder.imgCatIcon.setImageResource(R.drawable.ic_pickfile_pdf);
		}else {
