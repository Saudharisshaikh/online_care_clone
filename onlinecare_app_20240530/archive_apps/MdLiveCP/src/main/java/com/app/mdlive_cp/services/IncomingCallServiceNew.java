...
import com.app.onlinecarespecialist.oovoosample.Main.MainActivity;
...
public class IncomingCallServiceNew extends Service {
					...
					public void run() {
						...
						try {
							...
							if(isNetworkConnected()) {
								...
								System.out.println("--online care specialist IncommingCallService running");
	...
	public void onDestroy() {
		...
		System.out.println("--online care specialist IncommingCallService destroyed");
		t.cancel();
	}
