...
import com.app.mdlive_cp.adapters.ProblemsAdapter;
import com.app.mdlive_cp.api.ApiManager;
import com.app.mdlive_cp.model.ProblemBean;
...
public class ActivityProbelemList extends AppCompatActivity {
    ...
    public void getPatientsProblemsList() {
        ...
        client.post(DATA.baseUrl+"getPatientsProblemsList", params, new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, byte[] response) {
                ...
                try{
                    ...
                    System.out.println("--reaponce in getPatientsProblemsList: "+content);
                    ...
                    e.printStackTrace();
                    System.out.println("-- responce onsuccess: getPatientsProblemsList, http status code: "+statusCode+" Byte responce: "+response);
            ...
            public void onFailure(int statusCode, Header[] headers, byte[] errorResponse, Throwable e) {
                ...
                try {
                    ...
                    System.out.println("--onfail getPatientsProblemsList: " +content);
