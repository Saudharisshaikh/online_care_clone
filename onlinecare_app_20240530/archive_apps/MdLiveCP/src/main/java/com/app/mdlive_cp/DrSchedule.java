...
import com.app.mdlive_cp.adapters.DrScheduleAdapter;
import com.app.mdlive_cp.api.ApiManager;
import com.app.mdlive_cp.model.DrSheduleModel;
import com.app.mdlive_cp.model.SlotBean;
...
public class DrSchedule extends AppCompatActivity {
	...
	public void getDoctorsSlots(String drId,String aptmntDate) {
		...
		System.out.println("-- params in getDoctorsSlots: "+params.toString());
		...
		client.post(DATA.baseUrl+"/getDoctorsSlots/",params, new AsyncHttpResponseHandler() {
			...
			public void onSuccess(int statusCode, Header[] headers, byte[] response) {
				...
				try{
					...
					System.out.println("--responce in getDoctorsSlots: "+content);
					try {
					...
					e.printStackTrace();
					System.out.println("-- responce onsuccess: getDoctorsSlots, http status code: "+statusCode+" Byte responce: "+response);
			...
			public void onFailure(int statusCode, Header[] headers, byte[] errorResponse, Throwable e) {
				...
				try {
					...
					System.out.println("--responce in failure getDoctorsSlots: "+content);
