...
//
//
//public class CopyOfVChatListener extends Service {
//
...
//
//				try {
//					System.out.println("--online care vchat service");
//					if(qbUser!=null){
//						System.out.println("--online care vchat service qbuser id: "+qbUser.getId());
//					}
//
...
//
//			//    		System.out.println("--on camera data receive");
//			//    		
//			//    		Intent i = new Intent();
...
//				//                	
//				//                	if(count == 2) {
//				Intent intent = new Intent(CopyOfVChatListener.this, VideoCallScreen.class);
...
//		super.onDestroy();
//
//		System.out.println("--onlince care vchatlistener service destroyed");
//
//		t.cancel();
