...
import com.app.omranpatient.permission.PermissionsActivity;
import com.app.omranpatient.permission.PermissionsChecker;
...
public class Login extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, ApiCallBack{
	...
	public static final String CURRENT_APP = "omran_patient",
	HOSP_ID_PREFS_KEY = "hospital_id_from_servicve";

	public static String HOSPITAL_ID_EMCURA = "47";//Omran hosp id
