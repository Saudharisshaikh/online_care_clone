...
import com.app.omranpatient.adapter.MessageAdapter;
...
import com.app.omranpatient.util.ChoosePictureDialog;
...
public class ViewConversationActivity extends BaseActivity{
	...
	public void viewConversation(String doctorId) {
		...
		System.out.println("-- url in viewConversation: "+DATA.baseUrl+ApiManager.VIEW_CONVERSATIONS+doctorId+"/"+prefs.getString("id", "0"));
		//System.out.println("-- url in viewConversation: "+DATA.baseUrl+"/viewConversation/patient/"+doctorId+"/"+prefs.getString("id", ""));
	...
	public void viewConversationspecialist(String doctorId) {
		...
		System.out.println("-- url in viewConversation: "+DATA.baseUrl+ApiManager.VIEW_CONVERSATIONS_SPECIALIST+doctorId+"/"+prefs.getString("id", ""));
		//System.out.println("-- url in viewConversation: "+DATA.baseUrl+"/viewConversationspecialist/patient/"+doctorId+"/"+prefs.getString("id", ""));
	...
	public void sendMsg(final String doctorId,String msgText,final String to, boolean isImage) {
		...
		System.out.println("--params in sendmessagetoDoctor "+params.toString());
