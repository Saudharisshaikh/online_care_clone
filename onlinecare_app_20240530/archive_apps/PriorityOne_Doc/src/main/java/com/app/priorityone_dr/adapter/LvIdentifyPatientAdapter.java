...
import com.app.priorityone_dr.ActivityRefillDetails;
...
import com.app.priorityone_dr.model.UnknownPatientMedicationBean;
...
public class LvIdentifyPatientAdapter extends ArrayAdapter<IdentifyPatientBean> {
	...
	public void getPatientsPrescription(final IdentifyPatientBean identifyPatientBean) {
		...
		System.out.println("-- in getPatientsPrescription patient name "+identifyPatientBean.getFirst_name());
		...
		client.post(reqURL, params, new AsyncHttpResponseHandler() {
			...
			public void onSuccess(int statusCode, Header[] headers, byte[] response) {
				...
				try{
					...
					System.out.println("--reaponce in getPatientsPrescription: "+content);
