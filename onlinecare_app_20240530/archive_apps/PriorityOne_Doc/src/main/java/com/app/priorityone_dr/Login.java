...
import com.app.priorityone_dr.permission.PermissionsActivity;
import com.app.priorityone_dr.permission.PermissionsChecker;
...
public class Login extends AppCompatActivity implements ApiCallBack{
	...
	public static final String CURRENT_APP = "priorityone_doc";//by zohaib for PrirityOne doc
	public static final String HOSPITAL_ID_EMCURA = "30";//PrirityOne hosp id
