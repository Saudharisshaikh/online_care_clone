...
import com.app.priorityone_uc.adapter.LvLivecareDoctorsAdapter;
import com.app.priorityone_uc.adapter.NearbyHospitalsAdapter;
import com.app.priorityone_uc.api.ApiManager;
import com.app.priorityone_uc.model.HospitalsBean;
import com.app.priorityone_uc.model.NearbyDoctorBean;
import com.app.priorityone_uc.services.GPSTracker;
...
//	                R.id.map)).getMap();
	...
	public void getNearByDrs(String zipCode) {
		...
		client.get(DATA.baseUrl+"/searchDoctor/"+zipCode, new AsyncHttpResponseHandler() {
			@Override
