...
import com.app.priorityone_uc.permission.PermissionsActivity;
import com.app.priorityone_uc.permission.PermissionsChecker;
...
public class Login extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, ApiCallBack{
	...
	public static final String CURRENT_APP = "priorityone_uc",
	HOSP_ID_PREFS_KEY = "hospital_id_from_servicve";

	public static String HOSPITAL_ID_EMCURA = "30";//PrirityOne hosp id
