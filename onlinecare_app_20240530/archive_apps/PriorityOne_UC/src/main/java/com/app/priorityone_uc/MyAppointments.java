...
import com.app.priorityone_uc.adapter.MyAppointmentsAdapter;
...
public class MyAppointments extends BaseActivity {
	...
	private void getMyAppointmentsCall() {
		...
		System.out.println("-- params in getMyAppointment: "+params.toString());
		...
		client.post(DATA.baseUrl+"getMyAppointment", params, new AsyncHttpResponseHandler() {
			...
			public void onSuccess(int statusCode, Header[] headers, byte[] response) {
				...
				try{
					...
					System.out.println("--online care response in api getMyAppointment: "+content);
					...
					e.printStackTrace();
					System.out.println("-- responce onsuccess: getMyAppointment, http status code: "+statusCode+" Byte responce: "+response);
			...
			public void onFailure(int statusCode, Header[] headers, byte[] errorResponse, Throwable e) {
				...
				try {
					...
					System.out.println("-- getMyAppointment o failure : "+content);
