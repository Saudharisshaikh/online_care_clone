...
import static sg.com.temasys.skylink.sdk.sampleapp.Constants.ROOM_NAME_MULTI;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                edtRoomNameParty.setText(ROOM_NAME_MULTI);//ROOM_NAME_PARTY_DEFAULT
                ...
                setRoomNameParty(ROOM_NAME_MULTI, getActivity());//ROOM_NAME_PARTY_DEFAULT
