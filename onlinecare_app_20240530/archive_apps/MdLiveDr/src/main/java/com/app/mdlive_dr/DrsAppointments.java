...
import com.app.mdlive_dr.adapter.DrAppointmentsAdapter;
import com.app.mdlive_dr.api.ApiManager;
import com.app.mdlive_dr.model.DrAppointmentModel;
import com.app.mdlive_dr.model.ReportsModel;
...
import com.app.mdlive_dr.util.Database;
import com.app.mdlive_dr.util.GloabalMethods;
import com.app.mdlive_dr.util.SpinnerCustom;
...
//					msg = jsonObject.getString("msg");
                        ...
                        if(stats.equals("success")){
                            ...
                            for (int i = 0; i < drApptmentsArray.length(); i++) {
                                ...
                                String slot_id=apptmntObj.optString("slot_id", "0");
                                ...
                                appointmentModel = new DrAppointmentModel(id, patient_id, sub_patient_id, time, appointment_date, date,
                                        ...
                                        day,from_time,to_time,birthdate,gender,residency,phone,StoreName,PhonePrimary, pharmacy_address, slot_id);
