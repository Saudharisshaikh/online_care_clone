...
import static com.app.mdlive_dr.util.DATA.SIGNUP_URL;
import static com.app.mdlive_dr.util.DATA.baseUrl;
...
public class ApiManager {
	...
	//====Mds Live Company- Nursing Home APIs starts
	...
	public static final String CALL_HISTORY_ENCOUNTERS = "calling/encounters";
	//====Mds Live Company- Nursing Home APIs ends
	...
	public static final String PATIENT_CANCEL_APPTMNT = "patient/cancelAppointment";
	public static final String GET_DOCTOR_SLOTS2 = "doctor/getDoctorsSlots";
	public static final String UPDATE_APPOINTMENT = "doctor/updateAppointment";
