...
import com.app.mdlive_dr.adapter.VVReportImagesAdapter2;
...
public class LiveCareDetails extends BaseActivity {
	...
	tvSelPtPhone,tvSelPtEmail,tvSelPtAddress,tvSelPtDOB,tvSelPtCompanies;
	...
	LinearLayout layReports,layVideoCall,layMsg,layNEMT, layRemoveQueue,layInstantConnect,layPatientSheet;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		layPatientSheet = findViewById(R.id.layPatientSheet);
			...
			public void onClick(View v) {
				switch (v.getId()){
					...
					case R.id.layInstantConnect:
						...
						startActivity(intent);
						break;
					case R.id.layPatientSheet:
						DATA.isVideoCallFromLiveCare = true;//for remove pop after call
		...
		layPatientSheet.setOnClickListener(onClickListener);
	}
	...
	public void fetchDataCallback(String httpStatus, String apiName, String content) {
		...
		if(apiName.contains(ApiManager.PATIENT_DETAIL_URGENTCARE)){
			...
			try {
				...
				tvSelPtCompanies.setText(sbCompanies.toString());//"Nursing Home: "+
