...
public class DrAppointmentModel {
	...
	public DrAppointmentModel(String id, String patient_id,
			...
			String to_time,String birthdate,String gender,String residency,String phone,String StoreName,String PhonePrimary, String pharmacy_address, String slot_id) {
		super();
		this.id = id;
