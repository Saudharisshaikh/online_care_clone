...
import com.app.mdlive_dr.adapter.ScreeningToolAdapter;
...
import com.app.mdlive_dr.model.ScreeningToolQuestionBean;
        ...
        lvScreeningTool.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(screeningToolQuestionBeens.get(position).answer.equalsIgnoreCase("No")){
                    ...
                    System.out.println("-- ans:Yes  position:"+position);
                }else {
                    screeningToolQuestionBeens.get(position).answer = "No";
                    System.out.println("-- ans:No  position:"+position);
                }
