...
import com.app.amnm_uc.util.DatePickerFragment2;
...
import static com.app.amnm_uc.GetLiveCare.bodyParts;
import static com.app.amnm_uc.GetLiveCare.painSeverity;
	...
	showSelectedPharmacyBroadcast = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (intent.getAction().equals(GloabalMethods.SHOW_PHARMACY_BROADCAST_ACTION)) {
			    ...
			    //GM commented this for AMNM App
				/*if (GloabalMethods.selectedPharmacyBean.id.isEmpty()) {
