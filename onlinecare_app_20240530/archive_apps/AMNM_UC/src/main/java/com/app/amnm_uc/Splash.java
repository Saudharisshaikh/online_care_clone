...
public class Splash extends Activity {
	...
	ImageView ivSplashCall999,ivSplashCAll112;
...
//	loginToQB();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ivSplashCall999 = findViewById(R.id.ivSplashCall999);
		ivSplashCAll112 = findViewById(R.id.ivSplashCAll112);
		...
		ivSplashCall999.setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View v) {
				try {
					Intent callIntent = new Intent(Intent.ACTION_CALL);
					callIntent.setData(Uri.parse("tel:"+Uri.encode("999")));
					callIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
					startActivity(callIntent);
				}catch (Exception  e){e.printStackTrace();}
			}
		});
		ivSplashCAll112.setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View v) {
				try {
					Intent callIntent = new Intent(Intent.ACTION_CALL);
					callIntent.setData(Uri.parse("tel:"+Uri.encode("112")));
					callIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
					startActivity(callIntent);
				}catch (Exception  e){e.printStackTrace();}
			}
