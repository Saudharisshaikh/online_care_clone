...
import com.app.amnm_uc.permission.PermissionsActivity;
import com.app.amnm_uc.permission.PermissionsChecker;
...
public class Login extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, ApiCallBack{
	...
	public static final String CURRENT_APP = "amnm_uc",
	HOSP_ID_PREFS_KEY = "hospital_id_from_servicve";

	public static String HOSPITAL_ID_EMCURA = "46";//AMNM hosp id
