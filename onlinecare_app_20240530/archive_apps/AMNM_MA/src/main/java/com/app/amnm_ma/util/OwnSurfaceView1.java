 ...
 */
public class OwnSurfaceView1 extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private int FPS = 6; // by default 4 fps
    ...
    public OwnSurfaceView1(Context ctx, AttributeSet attrSet) {
        super(ctx, attrSet);
