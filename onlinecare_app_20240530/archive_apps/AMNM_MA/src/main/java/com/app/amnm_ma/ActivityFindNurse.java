...
public class ActivityFindNurse extends AppCompatActivity implements View.OnClickListener{
    ...
    TextView tvTabTCM,tvTabCC,tvTabHomeHealth,tvTabNursingHome,
            tvTabNurse,tvTabNursePractitioner,tvTabSocialWorker,tvTabDietitian,tvTabOT,tvTabPharmacist,tvTabMA;
    ListView lvNurse;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("-- on nurse activity patientType = "+patientType);
        try {
        ...
        client.post(reqURL, params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] response) {
                ...
                try{
                    ...
                    System.out.println("--reaponce in request_to_add_nurse "+content);
            ...
            public void onFailure(int statusCode, Header[] headers, byte[] errorResponse, Throwable e) {
                ...
                try {
                    String content = new String(errorResponse);
                    System.out.println("-- onfailure request_to_add_nurse : "+content);
                    new GloabalMethods(activity).checkLogin(content);
                    customToast.showToast(DATA.CMN_ERR_MSG,0,0);
        ...
        client.post(reqURL, params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] response) {
                ...
                try{
                    ...
                    System.out.println("--reaponce in delete_care_management "+content);
