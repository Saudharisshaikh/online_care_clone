...
import com.app.amnm_ma.adapter.DrAppointmentsAdapter;
import com.app.amnm_ma.api.ApiManager;
import com.app.amnm_ma.model.DrAppointmentModel;
import com.app.amnm_ma.model.ReportsModel;
...
import com.app.amnm_ma.util.SpinnerCustom;
...
//		/prefs.getString("id", "")
        ...
        spDates = findViewById(R.id.spDates);
        ...
        spinnerCont.setVisibility(View.GONE);//no need for MA
        ...
        lvDrApptments.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
                if (cbRefer.isChecked()) {
                    ...
                    System.out.println("-- isselected "+DATA.drsApptmentsList.get(position).isSelected);
        ...
        lvDrAwaitingAppointments.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
                if (cbRefer.isChecked()) {
                    ...
                    System.out.println("-- isselected DATA.awaitingAppointments "+DATA.awaitingAppointments.get(position).isSelected);
    ...
    private void getDrsAppointments1(String drId,final String apptmntDate) {
        ...
        //System.out.println("-- params in getDoctorAppointment "+params.toString());

        String reqURL = DATA.baseUrl+"getDoctorAppointment";
        ...
        client.post(reqURL, params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] response) {
                ...
                try{
                    ...
                    System.out.println("--online care response in getDrsAppointments : "+content);
...
//					msg = jsonObject.getString("msg");
                        ...
                        if(stats.equals("success")){
                            ...
                            for (int i = 0; i < drApptmentsArray.length(); i++) {
                                ...
                                String pharmacy_address=apptmntObj.optString("pharmacy_address", "-");
                                ...
                                appointmentModel = new DrAppointmentModel(id, patient_id, sub_patient_id, time, appointment_date, date,
                                        ...
                                        day,from_time,to_time,birthdate,gender,residency,phone,StoreName,PhonePrimary, pharmacy_address);
                        ...
                        System.out.println("--online care dr exception in getDrsAppointments: "+e);
    ...
    private void getDrsAppointmentsMA() {
        ...
        String reqURL = DATA.baseUrl+"ma/getDoctorAppointment";
...
//					msg = jsonObject.getString("msg");
                        ...
                        if(stats.equals("success")){
                            ...
                            for (int i = 0; i < drApptmentsArray.length(); i++) {
                                ...
                                appointmentModel.dr_name = apptmntObj.optString("dr_name","-");
    ...
    public void refferToAdmin(ArrayList<String> appointment_ids) {
        ...
        //System.out.println("--params in refferToAdmin "+params.toString());

        String reqURL = DATA.baseUrl+"/refertoAdmin/";
        ...
        client.post(reqURL,params ,new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] response) {
                ...
                try{
                    ...
                    System.out.println("--responce in refferToAdmin: "+content);
