...
public class LiveCareAdapter2 extends ArrayAdapter<MyAppointmentsModel> {

	Activity activity;
	ArrayList<MyAppointmentsModel> allAppointmentsOrig;

	public LiveCareAdapter2(Activity activity) {
	...
	static class ViewHolder {
		...
		TextView tvMyappntDate,tvPatientQueue,tvDocName;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		viewHolder.tvDocName.setText(DATA.allAppointments.get(position).doc_name);
...
//		});	
	...
	public void filter(String filterText) {
		...
		try {
			...
			System.out.println("---doctorsModelsOrg size: "+allAppointmentsOrig.size());
