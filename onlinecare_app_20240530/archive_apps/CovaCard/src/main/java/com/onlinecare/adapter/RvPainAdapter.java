...
import static com.onlinecare.GetLiveCare.painSevEmojies;
...
public class RvPainAdapter extends RecyclerView.Adapter<RvPainAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.ivPSEmoji.setImageResource(painSevEmojies[position]);
        holder.tvPSLbl.setText(painSeverity[position]);
