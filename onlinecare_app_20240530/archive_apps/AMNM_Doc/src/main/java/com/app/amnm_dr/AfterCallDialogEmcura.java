...
import com.app.amnm_dr.adapter.LabReportsAdapter;
import com.app.amnm_dr.adapter.TelemedicineAdapter;
import com.app.amnm_dr.adapter.TelemedicineAdapter2;
import com.app.amnm_dr.api.ApiManager;
import com.app.amnm_dr.model.LabReportBean;
import com.app.amnm_dr.model.TelemedicineCatData;
import com.app.amnm_dr.model.TelemedicineCategories;
import com.app.amnm_dr.model.TimeDiff;
...
public class AfterCallDialogEmcura extends BaseActivity {
	...
	protected void onResume() {
		...
		//AMNM work for get pt detials incomming call from MA
		if(!TextUtils.isEmpty(DialogPatientInfo.patientIdGCM)){
			DATA.selectedUserCallId = DialogPatientInfo.patientIdGCM;
			new GloabalMethods(activity).getPatientDetails(false);
		}

		if(TextUtils.isEmpty(DATA.selectedUserCallId) && DATA.isFromDocToDoc){
