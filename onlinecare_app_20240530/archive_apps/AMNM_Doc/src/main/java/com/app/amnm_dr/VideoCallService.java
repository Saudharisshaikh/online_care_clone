...
////		}
//
//		System.out.println("--online care selected call user id: "+DATA.selectedUserQbid);
//
//
//		opponentUser.setId(Integer.parseInt(DATA.selectedUserQbid));
//
//		System.out.println("--online care in videocallscreen before callFriend qb id"+DATA.selectedUserQbid);
//
