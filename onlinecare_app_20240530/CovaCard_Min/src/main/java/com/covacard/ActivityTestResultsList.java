...
import com.covacard.adapter.TestResultAdapter;
import com.covacard.model.TestResultBean;
...
public class ActivityTestResultsList extends ActivityBaseDrawer{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String testReslutsEmail = sharedPrefsHelper.get("test_results_email","testresults@covacard.com");
