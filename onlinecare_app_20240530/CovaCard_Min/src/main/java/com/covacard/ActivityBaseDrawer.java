        ...
        View.OnClickListener onClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(v.getId() == R.id.layHome){
                    ...
                    //new GloabalMethods(activity).showWebviewDialog("https://covacard.com/app/patient/privacy_policy", "Privacy Policy");
                    String url = "https://covacard.com/app/patient/privacy_policy";
                    try {
                    ...
                    //new GloabalMethods(activity).showWebviewDialog("https://covacard.com/app/patient/user_agreement", "Terms and Conditions");
                    String url = "https://covacard.com/app/patient/user_agreement";
                    try {
                        String app_general_labels = sharedPrefsHelper.get("app_general_labels", "");
                        if(!TextUtils.isEmpty(app_general_labels)){
                    ...
                    //new GloabalMethods(activity).showWebviewDialog("https://covacard.com/app/patient/subscription_policy", "Subscription Policy");
                    String url = "https://covacard.com/app/patient/subscription_policy";
                    try {
                        String app_general_labels = sharedPrefsHelper.get("app_general_labels", "");
                        if(!TextUtils.isEmpty(app_general_labels)){
                    ...
                    String[] addresses = {"info@covacard.com"};//"support@onlinecare.com"

                    Intent emailIntent = new Intent(Intent.ACTION_SENDTO, Uri.fromParts(
                            "mailto","info@covacard.com", null));//"support@onlinecare.com"
                    ...
                    String subject = getString(R.string.app_name)+" customer support";
                    String[] addresses = {"support@covacard.com"};//"support@onlinecare.com"

                    Intent emailIntent = new Intent(Intent.ACTION_SENDTO, Uri.fromParts(
                            "mailto","support@covacard.com", null));//"support@onlinecare.com"
                    emailIntent.putExtra(Intent.EXTRA_EMAIL, addresses); // String[] addresses
                    emailIntent.putExtra(Intent.EXTRA_SUBJECT, subject);
                    //emailIntent.putExtra(Intent.EXTRA_TEXT, "Body");
                    startActivity(Intent.createChooser(emailIntent, "Send email..."));
