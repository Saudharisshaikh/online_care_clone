...
//	public long PERIOD = 1300000;  // every .5 hr
...
//
//			loginToQB();
//			DATA.print("--online care login to qb in oncreate of msgService");			
//		}
//
...
//								initChatService();
//
//								DATA.print("--online care login to qb in timer run");
//								loginToQB();
//
////								Intent intent1 = new Intent();
////								intent1.setAction("com.app.onlinecaredr.START_VCHAT_SERVICE");
...
//		
//		DATA.print("--online care dr vchat service on start");
//
//		return START_STICKY;
//	}
//
...
//		ed.commit();
//
//		DATA.print("--online care dr service destroyed");
//
////		t.cancel();
//
//	}
...
//
//
//				DATA.print("--online care dr in logintoQB from service");
//				// Save current user
//				//
...
//
//							DATA.print("--online care dr in initVideoChat in service");
//
...
//						}
//
//						DATA.print("--online care dr after initVideoChat in service");
//						
//						SharedPreferences.Editor ed = prefs.edit();
