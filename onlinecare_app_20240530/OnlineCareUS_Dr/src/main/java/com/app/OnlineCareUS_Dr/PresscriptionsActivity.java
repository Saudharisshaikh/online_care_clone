...
import com.app.OnlineCareUS_Dr.adapter.PrescriptionAdapter;
import com.app.OnlineCareUS_Dr.adapter.PrescriptionCPAdapter;
import com.app.OnlineCareUS_Dr.adapter.PrescriptionCancelAdapter;
...
import com.app.OnlineCareUS_Dr.model.PrescriptionCancelBean;
		...
		if(apiName.equalsIgnoreCase(ApiManager.GET_PRESCRIPTIONS)){
			...
			try {
				...
				for (int i = 0; i < data.length(); i++) {
					...
					String presStatus = object.getString("status");
					String reqType = object.getString("request_type");
