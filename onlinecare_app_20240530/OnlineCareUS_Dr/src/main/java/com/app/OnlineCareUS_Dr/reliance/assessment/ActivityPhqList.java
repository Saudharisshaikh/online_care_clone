package com.app.OnlineCareUS_Dr.reliance.assessment;
...
public class ActivityPhqList extends BaseActivity{
    ...
    public static final String GAD_FORM_TITLE = "Generalized Anxiety Disorder 7-item (GAD-7) scale",
    PHQ_FORM_TITLE = "Patient Health Questionnaire (PHQ-9)";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(ActivityPHQ_Form.formFlag == 1){
            getSupportActionBar().setTitle(PHQ_FORM_TITLE);
        }else if(ActivityPHQ_Form.formFlag == 2){
            getSupportActionBar().setTitle(GAD_FORM_TITLE);
        }
