...
import com.app.OnlineCareUS_Dr.adapter.LvIdentifyPatientAdapter;
import com.app.OnlineCareUS_Dr.api.ApiManager;
import com.app.OnlineCareUS_Dr.model.DrugBean;
import com.app.OnlineCareUS_Dr.model.DrugRefillBean;
import com.app.OnlineCareUS_Dr.model.IdentifyPatientBean;
import com.app.OnlineCareUS_Dr.model.PotencyUnitBean;
...
public class ActivityRefillDetails extends BaseActivity {
	...
	ImageView ic_mike_vitals , ic_mike_Diagnosis;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ic_mike_vitals = (ImageView) findViewById(R.id.ic_mike_vitals);
		ic_mike_Diagnosis = (ImageView) findViewById(R.id.ic_mike_Diagnosis);

		ic_mike_vitals.setOnClickListener(v ->
		{
			startVoiceRecognitionActivity(etVitals);
		});

		ic_mike_Diagnosis.setOnClickListener(v ->
		{
			startVoiceRecognitionActivity(etDiagnosis);
		});
	...
	ArrayList<DrugBean> drugBeans;
	 ...
	 EditText editText;
		...
		private void startVoiceRecognitionActivity(EditText editText) {
			...
			voiceRecogActivityResultLauncher.launch(intent);
	...
	//ahmer's code for change startActivityforresult (Depreceted) to ActivityResultLauncher 03-02-23
	ActivityResultLauncher<Intent> voiceRecogActivityResultLauncher = registerForActivityResult(
	...
	//ahmer's code end for change startActivityforresult (Depreceted) to ActivityResultLauncher 03-02-23
