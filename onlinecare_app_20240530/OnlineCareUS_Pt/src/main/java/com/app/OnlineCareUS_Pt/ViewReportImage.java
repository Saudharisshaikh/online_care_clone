...
import com.app.OnlineCareUS_Pt.util.Download;
...
public class ViewReportImage extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		DATA.print("-- extention: "+extention+" url: "+DATA.selctdReprtURLForVu);
		if(extention.equals(".png" ) || extention.equals(".jpg" ) || extention.equals(".jpeg" )) {
			...
			wvReport.setWebViewClient(new WebViewClient(){
				...
				public void onReceivedError(WebView view, WebResourceRequest request, WebResourceError error) {
					...
					DATA.print("-- web view onReceivedError Request : "+request.toString()+ " . Error : "+error.toString());
				}
				...
				public void onReceivedHttpError(WebView view, WebResourceRequest request, WebResourceResponse errorResponse) {
					...
					DATA.print("-- web view onReceivedHttpError Request : "+request.toString()+ " . Error : "+errorResponse.toString());
				}
			});
			...
			DATA.print("-- in extention.equals(\".pdf\"): "+extention.equals(".pdf"));
			DATA.print("-- pdf URL: "+"https://docs.google.com/gview?embedded=true&url="+DATA.selctdReprtURLForVu);
		}
		/*else if(extention.equals(".docx") || extention.equals(".doc")) {
			imgViewReport.setImageResource(R.drawable.icon_doc);
		} else if(extention.equals(".xls") || extention.equals(".xlsx")) {
