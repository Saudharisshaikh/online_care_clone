...
//						try {
//							DATA.print("--online care in videocallscreen login onSuccess");
//
//							QBVideoChatController.getInstance().initQBVideoChatMessageListener();
//							DATA.print("--online care in videocallscreen login onSuccess after getInstance.initQBVideoChatMessageListener");
//
//						} catch (XMPPException e) {
//							DATA.print("--online care in videocallscreen login onSuccess after getInstance.initQBVideoChatMessageListener exception "+e);
//
//
//							e.printStackTrace();
//						}
