...
import com.app.OnlineCareTDC_Dr.fcm.MyFirebaseMessagingService;
...
import com.app.OnlineCareTDC_Dr.util.RingtonePlayer;
...
/*
    ...
    public void setResults() {// call is accepted/rejected by other user called from incommingCallResponce
        ...
        stopCallNotification();
        if(!MainActivity.this.isFinishing() && pd != null){pd.dismiss();}
        //hideWaitingMessage();
