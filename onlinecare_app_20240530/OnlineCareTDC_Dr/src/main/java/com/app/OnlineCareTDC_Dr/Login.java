...
public class Login extends AppCompatActivity implements ApiCallBack {
    ...
    public static final String CURRENT_APP = "tdc_doctor";//by zohaib for OLC US doc
    public static final String HOSP_ID_PREFS_KEY = "hospital_id_from_servicve";
    public static String HOSPITAL_ID_EMCURA = "49"; //1 Onlinecare US hosp id
        ...
        if (apiName.equals(ApiManager.DOCTOR_LOGIN)) {
            try {
                ...
                if (status.equals("success")) {
                    ...
                    if (user_info.has("schedule_end_date")) {

                        String sedStr = user_info.getString("schedule_end_date");
                        try {
                            SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd");
                            Date d = simpleDateFormat.parse(sedStr);
                            SimpleDateFormat sdf = new SimpleDateFormat("MM/dd/yyyy");
                            sedStr = sdf.format(d);
                        } catch (ParseException e) {
                            e.printStackTrace();
                        }
                        ed.putString("schedule_end_date", sedStr);
                    }
//					else
//					{
...
//							activity.sendBroadcast(intent1);
                    ...
                    //getOAuthToken(); //ahmer change this after disscuss with zohaib bhai 19/5/23
                    openActivity.open(MainActivityNew.class, true);//Splash
