...
import com.app.OnlineCareTDC_Dr.DocToDoc;
import com.app.OnlineCareTDC_Dr.R;
import com.app.OnlineCareTDC_Dr.adapter.NotesAdapter2;
import com.app.OnlineCareTDC_Dr.api.ApiCallBack;
import com.app.OnlineCareTDC_Dr.api.ApiManager;
import com.app.OnlineCareTDC_Dr.model.CallLogBean;
...
public class DialogCallDetails implements ApiCallBack, DialogAddEncNoteFromCallHist.RefreshEncounterNotesInterface {
    ...
    public void initDetailsDialog(CallLogBean callLogBean) {
        ...
        ImageView ivIsonline = dialogCallDetails.findViewById(R.id.ivIsonline);

        int isOnlineResID = callLogBean.is_online.equalsIgnoreCase("1") ? R.drawable.icon_online : R.drawable.icon_notification;
        ivIsonline.setImageResource(isOnlineResID);
            ...
            btnSendEncNotes.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(activity instanceof ActivityCallLogs){
                        ((ActivityCallLogs) activity).dialogAddEncNoteFromCallHistObj =
                                new DialogAddEncNoteFromCallHist(activity, callLogBean, DialogCallDetails.this);
                        ((ActivityCallLogs) activity).dialogAddEncNoteFromCallHistObj.showTelemedicineDialog();
                    }
                }
            });
    ...
    public void getLivecareId(String patientId) {
        ...
        //DATA.print("-- url in getLivecareId: "+DATA.baseUrl+"getLivecareId/"+patientId+"/"+prefs.getString("id",""));
        ...
        client.post(reqURL , new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] response) {
                ...
                try{
                    ...
                    DATA.print("--reaponce in getLivecareId: "+content);
                    try {
