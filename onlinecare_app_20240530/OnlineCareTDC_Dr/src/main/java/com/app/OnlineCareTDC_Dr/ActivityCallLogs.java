...
import com.app.OnlineCareTDC_Dr.adapter.CallLogsAdapter;
...
import com.app.OnlineCareTDC_Dr.util.DialogCallDetails;
...
public class ActivityCallLogs extends BaseActivity implements GloabalSocket.SocketEmitterCallBack{
	...
	public void fetchDataCallback(String status, String apiName, String content) {
		...
		else if (apiName.contains(ApiManager.FORWARD_NOTE))
		{
			try {
				JSONObject jsonObject = new JSONObject(content);
				String statusNote = jsonObject.getString("status");
				String msg = jsonObject.getString("message");
				if (statusNote.equalsIgnoreCase("success"))
				{
	...
	public void forwardNote(String noteId)
	{
		RequestParams params = new RequestParams();
		params.put("note_id", noteId);
//		ApiManager.shouldShowPD = false;
		ApiManager apiManager = new ApiManager(ApiManager.FORWARD_NOTE,"post",params,apiCallBack, activity);
		apiManager.loadURL();
	}


	public DialogAddEncNoteFromCallHist dialogAddEncNoteFromCallHistObj = null;
	@Override
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		super.onActivityResult(requestCode, resultCode, data);
		if(dialogAddEncNoteFromCallHistObj != null){
			//Insurance card image
			dialogAddEncNoteFromCallHistObj.onActivityResult(requestCode, resultCode, data);
		}
