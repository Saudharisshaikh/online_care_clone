...
public class MessageAdapterForDoctor extends ArrayAdapter<MessageBean> {
	...
	public MessageAdapterForDoctor(Activity activity , ArrayList<MessageBean> messageBeans) {
...
//		filter(DATA.selectedDrId);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (!messageBeans.get(position).getDoctor_id().equalsIgnoreCase(prefs.getString("id", ""))) {
