...
public class LiveCareDetails extends BaseActivity {
	...
	LinearLayout layReports,layVideoCall,layMsg,layNEMT, layRemoveQueue,layInstantConnect,laySoapNotes,layEncounterNote;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		laySoapNotes = findViewById(R.id.laySoapNotes);
		...
		ed.putString("patient_id", DATA.selectedUserCallId);
		ed.commit();
		//end
	...
	public void fetchDataCallback(String httpStatus, String apiName, String content) {
		...
		if(apiName.contains(ApiManager.PATIENT_DETAIL_URGENTCARE)){
			...
			try {
				...
				ActivityTcmDetails.pt_id = patient_data.getString("id");
