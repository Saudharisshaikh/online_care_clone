...
public class ActivityEncounterNotes extends AppCompatActivity implements ApiCallBack{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.acitvity_encounter_notes);

        this.activity = ActivityEncounterNotes.this;
        ...
        getNotes(ActivityTcmDetails.pt_id);
    }
