package com.app.OnlineCareTDC_Dr.permission;
...
public class PermissionsChecker {
    ...
    public boolean lacksPermission(String permission) {
        System.out.println("-- gmgm - lacksPermission - Permission : "+permission + " , status : "+ContextCompat.checkSelfPermission(context, permission));
