...
public class ActivitySOAP extends AppCompatActivity implements ApiCallBack{
    ...
    protected void onResume() {
        getNotes("","");
        ActivitySoapNotesNew.teleMedServices = "";
        super.onResume();
    }
    ...
    public void getNotes(String search_doctor_id,String search_date) {
        ...
        //params.put("patient_id", SharedPrefsHelper.getInstance().get("patient_id" , ""));
            ...
            try {
                ...
                if (jsonArray.length() == 0) {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        if (jsonArray.getJSONObject(i).getJSONObject("notes").has("condition")) {
                            condition = jsonArray.getJSONObject(i).getJSONObject("notes").getString("condition");
                        }
                        if (jsonArray.getJSONObject(i).getJSONObject("notes").has("symptom")) {
                            symptom = jsonArray.getJSONObject(i).getJSONObject("notes").getString("symptom");
                        }
                        ...
                        bean.symptom = condition;
                        bean.condition = condition;
