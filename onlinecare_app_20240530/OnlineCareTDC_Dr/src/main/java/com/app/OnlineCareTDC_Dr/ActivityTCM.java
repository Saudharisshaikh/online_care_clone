...
import com.app.OnlineCareTDC_Dr.adapter.CallLogsAdapter2;
import com.app.OnlineCareTDC_Dr.adapter.LiveCareAdapter;
...
public class ActivityTCM extends BaseActivity implements View.OnClickListener, ApiCallBack,GloabalSocket.SocketEmitterCallBack{
    ...
    private void getPatientBycategory(String patient_category) {
        ...
        ApiManager apiManager = new ApiManager(ApiManager.GET_PATIENT_BY_PCP,"post",params,this, activity);
        apiManager.loadURL();
    }
    ...
    public void fetchDataCallback(String status, String apiName, String content) {
        if(apiName.equalsIgnoreCase(ApiManager.GET_PATIENT_BY_PCP)){
            try {
                srTCM.setRefreshing(false);
                ...
                for(int i = 0; i<appointmentsArray.length(); i++) {
                    ...
                    temp.patients_qbid = appointmentsArray.getJSONObject(i).optString("patients_qbid");
                ...
                liveCareAdapter = new LiveCareAdapter(activity , DATA.allAppointments);
