...
import com.app.OnlineCareTDC_Dr.adapter.PrescriptionAdapter;
...
public class PresscriptionActivity extends AppCompatActivity implements ApiCallBack{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getPresscriptions(SharedPrefsHelper.getInstance().get("patient_id"));
	...
	public void getPresscriptions(String patientId) {
		...
		ApiManager apiManager = new ApiManager(ApiManager.GET_PRESCRIPTIONS_PT,"post",params,apiCallBack, activity);
		apiManager.loadURL();
	}

	@Override
	public void fetchDataCallback(String status, String apiName, String content) {
		if(apiName.equalsIgnoreCase(ApiManager.GET_PRESCRIPTIONS_PT)){
			try {
