package com.app.OnlineCareTDC_Dr.api;
...
import static com.app.OnlineCareTDC_Dr.util.DATA.SIGNUP_URL;
import static com.app.OnlineCareTDC_Dr.util.DATA.baseUrl;
...
public class ApiManager {
	...
	//public static final String DOCTOR_LOGIN = "patient/login";
	...
	public static final String GET_PATIENT_BY_PCP = "doctor/getPatientByPcp";
	...
	public static final String GET_PRESCRIPTIONS_PT = "patient/getPrescriptions";
	...
	public static final String GET_ICD_CODES_SERVICES = "icdcodes/get_codes";
	public static final String SAVE_LIVECARE_ICDCODES = "icdcodes/save_livecare_icdcode";
	...
	public static final String FORWARD_NOTE ="notes/forwardnote";
