...
import com.app.OnlineCareTDC_MA.adapter.CategoriesAdapter;
import com.app.OnlineCareTDC_MA.api.ApiCallBack;
import com.app.OnlineCareTDC_MA.api.ApiManager;
import com.app.OnlineCareTDC_MA.model.CategoriesModel;
import com.app.OnlineCareTDC_MA.model.MyAppointmentsModel;
import com.app.OnlineCareTDC_MA.permission.PermissionsActivity;
import com.app.OnlineCareTDC_MA.permission.PermissionsChecker;
import com.app.OnlineCareTDC_MA.reliance.therapist.ActivityReferedPatients;
import com.app.OnlineCareTDC_MA.services.GPSTracker;
import com.app.OnlineCareTDC_MA.util.ActionEditText;
import com.app.OnlineCareTDC_MA.util.CallWebService;
import com.app.OnlineCareTDC_MA.util.CheckInternetConnection;
import com.app.OnlineCareTDC_MA.util.CustomToast;
import com.app.OnlineCareTDC_MA.util.DATA;
import com.app.OnlineCareTDC_MA.util.Database;
import com.app.OnlineCareTDC_MA.util.DialogPatientInfo;
import com.app.OnlineCareTDC_MA.util.GloabalMethods;
import com.app.OnlineCareTDC_MA.util.GloabalSocket;
import com.app.OnlineCareTDC_MA.util.HideShowKeypad;
import com.app.OnlineCareTDC_MA.util.OpenActivity;
import com.app.OnlineCareTDC_MA.util.SharedPrefsHelper;
...
public class MainActivityNew extends AppCompatActivity implements ApiCallBack, GloabalSocket.SocketEmitterCallBack{
    ...
    LinearLayout tvLiveCare;//,tvCovidList;
    TextView  tvAppointments, tvDrProfile, tvLogout,tvDrSchedule,
            ...
            tvInstantConnect,tvAppInvite,tvReffredPt, tvCovidList,tvCareRequests;
    TextView tvMessagesBadge,tvLiveCareBadge,tvAppointmentBadge,tvPrescriptionsBadge,tvRefillsBadge,
            tvGroupsBadge,tvAddDoctorBadge,tvSoapRefBadge,tvCareRequestsBadge,tvCovidBadge;
    ...
    public void setBadge(Database database){//Activity activity
     ...
     /*   ArrayList<String> allNotifications = db.getAllNotif();
        ...
        final ArrayList<String> careRequests = database.getAllNotifByType(DATA.NOTIF_TYPE_CARE_REQ);
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if(tvCareRequestsBadge!=null){
                    if(careRequests!= null){
                        DATA.print("--careRequests size "+careRequests.size());
                        if(careRequests.size() > 0){
                            tvCareRequestsBadge.setText(careRequests.size() + "");
                            //badge.setTextSize(12);
                            tvCareRequestsBadge.setVisibility(View.VISIBLE);
                        }else {
                            tvCareRequestsBadge.setVisibility(View.GONE);
                        }
                    }else {
                        tvCareRequestsBadge.setVisibility(View.GONE);
                    }
...
//		exportDB();
        ...
        tvCareRequests = findViewById(R.id.tvCareRequests);
        ...
        tvCareRequestsBadge = findViewById(R.id.tvCareRequestsBadge);
...
//				openActivity.open(HomeHealth.class, false);
        ...
        tvCareRequests.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
