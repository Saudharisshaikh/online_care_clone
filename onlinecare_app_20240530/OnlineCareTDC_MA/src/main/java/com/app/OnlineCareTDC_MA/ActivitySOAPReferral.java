...
import com.app.OnlineCareTDC_MA.adapter.DmeRefAdapter;
import com.app.OnlineCareTDC_MA.adapter.HomecareAdapter;
import com.app.OnlineCareTDC_MA.adapter.ViewSkilledNursingAdapter;
import com.app.OnlineCareTDC_MA.api.ApiCallBack;
import com.app.OnlineCareTDC_MA.api.ApiManager;
import com.app.OnlineCareTDC_MA.model.SoapReferralBean;
...
public class ActivitySOAPReferral extends BaseActivity implements ApiCallBack{
    ...
    protected void onResume() {
        ...
        ApiManager apiManager = new ApiManager(ApiManager.PENDING_REFERRALS,"post",params,apiCallBack, activity);
        apiManager.loadURL();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activity = ActivitySOAPReferral.this;
        ...
        lvSoapReferrals.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                selectedSoapReferralBean = soapReferralBeen.get(position);
                if(dmeOrSkilled == 0){
    ...
    public void fetchDataCallback(String status, String apiName, String content) {
        if(apiName.equalsIgnoreCase(ApiManager.PENDING_REFERRALS)){
            try {
                //soapReferralBeen = new ArrayList<>();
