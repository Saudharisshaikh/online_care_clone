...
public class Login extends AppCompatActivity implements ApiCallBack{
	...
	public static final String CURRENT_APP = "tdc_ma",
			HOSP_ID_PREFS_KEY = "hospital_id_from_servicve";//by zohaib for olc US MA

	String hospitalIdLogin = "49";

	public static String HOSPITAL_ID_EMCURA = "49";//Onlinecare US hosp id
			...
			public void onClick(View v) {
				...
				if (count == 10) {
					if (prefs.getString(HOSP_ID_PREFS_KEY , "").equalsIgnoreCase("49")) {
						...
						checkedItem = hospitalIdLogin.equalsIgnoreCase(Login.HOSPITAL_ID_EMCURA) ? 1 : 0;
					}
