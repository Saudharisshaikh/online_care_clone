...
import com.app.OnlineCareTDC_MA.adapter.TransectionAdapter;
import com.app.OnlineCareTDC_MA.api.ApiCallBack;
import com.app.OnlineCareTDC_MA.api.ApiManager;
import com.app.OnlineCareTDC_MA.model.TransectionBean;
...
public class TransectionsActivity extends AppCompatActivity implements ApiCallBack {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ApiManager apiManager = new ApiManager(ApiManager.GET_DOCTOR_TRANSACTIONS+"/"+prefs.getString("id", "0"),"get",null,apiCallBack, activity);
		apiManager.loadURL();
	...
	public void fetchDataCallback(String status, String apiName, String content) {
		if(apiName.contains(ApiManager.GET_DOCTOR_TRANSACTIONS)){
			try {
