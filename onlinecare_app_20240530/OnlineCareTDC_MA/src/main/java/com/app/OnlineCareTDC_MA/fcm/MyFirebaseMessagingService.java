...
package com.app.OnlineCareTDC_MA.fcm;
...
import com.app.OnlineCareTDC_MA.ActivityAddDoctor;
import com.app.OnlineCareTDC_MA.ActivityRifills;
import com.app.OnlineCareTDC_MA.ActivityTelemedicineServices;
import com.app.OnlineCareTDC_MA.BuildConfig;
import com.app.OnlineCareTDC_MA.ConversationsActivity;
import com.app.OnlineCareTDC_MA.DrsAppointments;
import com.app.OnlineCareTDC_MA.LiveCare;
import com.app.OnlineCareTDC_MA.Login;
import com.app.OnlineCareTDC_MA.MainActivityNew;
import com.app.OnlineCareTDC_MA.OnlineCareDr;
import com.app.OnlineCareTDC_MA.PresscriptionsActivity;
import com.app.OnlineCareTDC_MA.R;
import com.app.OnlineCareTDC_MA.ShowGroupMessagePopup;
import com.app.OnlineCareTDC_MA.ShowLiveCarePopup;
import com.app.OnlineCareTDC_MA.ShowMessagePopupActivity;
import com.app.OnlineCareTDC_MA.SupportMessagesActivity;
import com.app.OnlineCareTDC_MA.VCallModule;
import com.app.OnlineCareTDC_MA.ViewConversationActivity;
import com.app.OnlineCareTDC_MA.model.ConversationBean;
import com.app.OnlineCareTDC_MA.model.SupportMessageBean;
import com.app.OnlineCareTDC_MA.services.IncomingCallResponse;
import com.app.OnlineCareTDC_MA.util.DATA;
import com.app.OnlineCareTDC_MA.util.DialogPatientInfo;
import com.app.OnlineCareTDC_MA.util.EasyAES;
...
//{"current_time":"2016-01-05 22:28:38","future_time":"2016-01-05 22:30:38","data":{"status":"accept"}}
        try {
            ...
            if (status.equalsIgnoreCase("connected")) {
                ...
                sendNotification("You have new Live Care patient request in queue.", MainActivityNew.class);
            }else if(status.equals("new_cform")){
                new DATA().insertNotification(context,DATA.NOTIF_TYPE_COVID_REQ);
                sendNotification("You have new Covid Care patient request in queue.", MainActivityNew.class);
