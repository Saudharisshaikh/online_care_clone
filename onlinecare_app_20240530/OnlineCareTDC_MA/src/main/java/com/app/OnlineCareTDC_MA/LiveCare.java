...
import com.app.OnlineCareTDC_MA.adapter.LiveCareAdapter2;
...
public class LiveCare extends BaseActivity implements ApiCallBack,GloabalSocket.SocketEmitterCallBack{
	...
	LiveCareAdapter2 myAppointmentsAdapter;
				...
				if(status.equals("success"))
				{
					...
					if (appointmentsArray.length() == 0) {
						...
						for(int i = 0; i<appointmentsArray.length(); i++) {
							...
							temp.doc_name = appointmentsArray.getJSONObject(i).optString("doc_name", "-");
						...
						myAppointmentsAdapter = new LiveCareAdapter2(activity);
						lvLiveCare.setAdapter(myAppointmentsAdapter);
