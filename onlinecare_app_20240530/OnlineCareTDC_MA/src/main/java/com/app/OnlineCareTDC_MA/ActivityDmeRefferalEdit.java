...
import com.app.OnlineCareTDC_MA.adapter.SkilledNursingAdapter;
import com.app.OnlineCareTDC_MA.model.SkilledNursingCheckBean;
...
public class ActivityDmeRefferalEdit extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activity = ActivityDmeRefferalEdit.this;
        ...
        btnDmeDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(! GloabalMethods.faxId.isEmpty()){//need to correctly send fax_id, if fax_id present in edit dme json then send that one!
    ...
    String dmeRef = ActivitySoapNotesEditNew.selectedNotesBean.dme_referral;
