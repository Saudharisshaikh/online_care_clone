...
import com.app.OnlineCareTDC_MA.util.AsyncReceiveMessage;
...
//	public long PERIOD = 2000;  
					...
					public void run() {
						...
						try {
							...
							if(isNetworkConnected()) {
								...
								asyncReceiveMessage.executeAsyncReceiveMessage();

								DATA.print("--online care outgoing call service running");
								
							}

						} catch (Exception e) {
							DATA.print("--exception in outgoingCallService");
							e.printStackTrace();
						}	
					}
				});
	...
	public void onDestroy() {
		...
		DATA.print("--online care dr outgoing call service destroyed");
		t.cancel();
	}
