...
import com.app.OnlineCareTDC_MA.adapter.BillingAdapter;
import com.app.OnlineCareTDC_MA.api.ApiManager;
import com.app.OnlineCareTDC_MA.model.BillingBean;
        ...
        client.post(DATA.baseUrl+"nursePendingNotes", params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] response) {
                ...
                try{
                    ...
                    DATA.print("--reaponce in nursePendingNotes: "+content);
                    ...
                    e.printStackTrace();
                    DATA.print("-- responce onsuccess: nursePendingNotes, http status code: "+statusCode+" Byte responce: "+response);
            ...
            public void onFailure(int statusCode, Header[] headers, byte[] errorResponse, Throwable e) {
                ...
                try {
                    ...
                    DATA.print("-- onfailure nursePendingNotes : "+content);
