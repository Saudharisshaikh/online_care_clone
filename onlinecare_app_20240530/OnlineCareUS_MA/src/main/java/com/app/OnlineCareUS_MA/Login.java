...
public class Login extends AppCompatActivity implements ApiCallBack{
	...
	public static final String CURRENT_APP = "ma_olc_us";//by zohaib for olc US MA

	final int LOCATION_PERMISSION_REQUEST_CODE = 954;

	public static final String HOSP_ID_PREFS_KEY = "hospital_id_from_servicve";
	public static String HOSPITAL_ID_EMCURA = "48"; //1 Onlinecare US hosp id
	String hospitalIdLogin = "48";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getHospitalDataById(prefs.getString("hospitalIdLogin","48"));
	}
