...
import com.app.mhcsn_cp.adapters.NurseAdapter2;
...
public class ActivityCareProviders extends BaseActivity implements ApiCallBack,GloabalSocket.SocketEmitterCallBack{
    ...
    ListView lvNurse;
    TextView tvTabNurse,tvTabNursePractitioner,tvTabSocialWorker,tvTabDietitian,tvTabOT,tvTabPharmacist,tvTabOM,tvTabMA,tvTabSup,tvTabAll;
    ...
    public void find_nurse(String keyword) {
        ...
        DATA.print("-- selectedCompanyID = "+selectedCompanyID);
