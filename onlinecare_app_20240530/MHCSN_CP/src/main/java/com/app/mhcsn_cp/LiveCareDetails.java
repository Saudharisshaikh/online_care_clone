...
public class LiveCareDetails extends BaseActivity {
	...
	LinearLayout layReports,layVideoCall,layMsg,layNEMT, layRemoveQueue,layInstantConnect,layBhealthAssess;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnReferToSpecialist.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				//note : this is done in doc app . GM
		...
		btnReferToPCP.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				//new GloabalMethods(activity).referToPCP(DATA.selectedUserAppntID);//note : this is done in doc app . GM
			}
		});
					...
					case R.id.layRemoveQueue:
						new AlertDialog.Builder(activity, R.style.CustomAlertDialogTheme)
								...
								.setPositiveButton("Yes Remove", new DialogInterface.OnClickListener() {
									@Override
									public void onClick(DialogInterface dialog, int which) {
										Intent intent = new Intent(activity, AfterCallDialog.class);
	...
	public void showOptionsDialog(){
		...
		btnSelPtViewMedicalHistory.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				//dialogOptions.dismiss();
				openActivity.open(PatientMedicalHistoryNew.class, false);
	...
	public void fetchDataCallback(String httpStatus, String apiName, String content) {
		...
		if(apiName.contains(ApiManager.PATIENT_DETAIL_URGENTCARE)){
			...
			try {
				...
				if(patient_data.has("pharmacy_address")){
					DATA.selectedRefferedLiveCare.pharmacy_address = patient_data.getString("pharmacy_address");
				}
				...
				ActivityTcmDetails.phistory = medical_history.getString("phistory");
				etSOAPHistoryMedical.setText(ActivityTcmDetails.phistory);
		...
		}else if(apiName.equalsIgnoreCase(ApiManager.BHEALTH_GET_ATTACH_SURVEY)){
	...
	public void getAttachSurvery(){
		RequestParams params = new RequestParams();
		params.put("livecare_id", DATA.selectedUserAppntID);
		ApiManager apiManager = new ApiManager(ApiManager.BHEALTH_GET_ATTACH_SURVEY,"post",params,apiCallBack, activity);
		apiManager.loadURL();
	}
