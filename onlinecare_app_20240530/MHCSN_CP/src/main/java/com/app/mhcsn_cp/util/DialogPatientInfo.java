...
public class DialogPatientInfo implements ApiCallBack{
    ...
    public DialogPatientInfo(AppCompatActivity activity) {
    ...
    public void showDialog(){
        ...
        btnVirtualVisit = infoDialog.findViewById(R.id.btnVirtualVisit);

        btnVirtualVisit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                infoDialog.dismiss();
                new DialogPatientVV(activity).showAddVirtualVisitDialog();
            }
        });
    ...
    public static void showPicDialog(Activity activity,String imgURL){
        final Dialog picDialog = new Dialog(activity,R.style.TransparentThemeBlack);
        picDialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
        picDialog.setContentView(R.layout.activity_herat_beat);
