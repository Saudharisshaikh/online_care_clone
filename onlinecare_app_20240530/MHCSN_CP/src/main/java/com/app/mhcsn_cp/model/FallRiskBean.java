...
public class FallRiskBean {
    ...
    public FallRiskBean(String id, String patient_id, String doctor_id, String age_65, String diagnosis, String prior_history,
                        String incontinence, String visual_impairment, String impaired_functional_mobility, String environment_hazards,
                        String poly_pharmacy, String pain_affection, String cognitive_impairment, String score, String dateof, String status,
                        String is_deleted, String delete_date,String is_lock,
                        String doctor_name,String doctor_category) {
        this.id = id;
