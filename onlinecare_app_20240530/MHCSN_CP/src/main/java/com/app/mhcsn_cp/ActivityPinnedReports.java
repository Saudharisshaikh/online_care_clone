...
import com.app.mhcsn_cp.adapters.ReportsPinedAdapter;
import com.app.mhcsn_cp.api.ApiManager;
import com.app.mhcsn_cp.model.FileBean;
import com.app.mhcsn_cp.model.FolderBean;
...
public class ActivityPinnedReports extends AppCompatActivity {
    ...
    public void patient_folders_files() {
        ...
        DATA.print("-- URL in patient_folders_files : "+reqURL);
        DATA.print("-- params in patient_folders_files: "+params.toString());
        ...
        client.post(reqURL,params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] response) {
                ...
                try{
                    ...
                    e.printStackTrace();
                    DATA.print("-- responce onsuccess: patient_folders_files, http status code: "+statusCode+" Byte responce: "+response);
            ...
            public void onFailure(int statusCode, Header[] headers, byte[] errorResponse, Throwable e) {
                ...
                try {
                    ...
                    DATA.print("--onfail patient_folders_files " +content);
