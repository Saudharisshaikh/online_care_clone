...
public class FollowupAdapter3 extends ArrayAdapter<FollowupBean> {

	AppCompatActivity activity;
	ArrayList<FollowupBean> followupBeens;

	public FollowupAdapter3(AppCompatActivity activity, ArrayList<FollowupBean> followupBeens) {
		super(activity, R.layout.followup_row_3, followupBeens);
	...
	static class ViewHolder {
		...
		TextView tvPatientName,tvFollowupDate;//tvPatientCat  tvSchedule
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null) {
			...
			LayoutInflater layoutInflater = (LayoutInflater) activity.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
			 convertView = layoutInflater.inflate(R.layout.followup_row_3, null);
