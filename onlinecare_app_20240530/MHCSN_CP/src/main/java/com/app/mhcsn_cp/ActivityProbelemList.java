...
import com.app.mhcsn_cp.adapters.ProblemsAdapter;
import com.app.mhcsn_cp.api.ApiManager;
import com.app.mhcsn_cp.model.ProblemBean;
        ...
        client.post(DATA.baseUrl+"getPatientsProblemsList", params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] response) {
                ...
                try{
                    ...
                    e.printStackTrace();
                    DATA.print("-- responce onsuccess: getPatientsProblemsList, http status code: "+statusCode+" Byte responce: "+response);
            ...
            public void onFailure(int statusCode, Header[] headers, byte[] errorResponse, Throwable e) {
                ...
                try {
                    ...
                    DATA.print("--onfail getPatientsProblemsList: " +content);
