...
import com.app.mhcsn_cp.model.DrugRefillBean;
		...
		client.post(DATA.baseUrl+"refillSummary", params, new AsyncHttpResponseHandler() {
			...
			public void onSuccess(int statusCode, Header[] headers, byte[] response) {
				...
				try{
					...
					e.printStackTrace();
					DATA.print("-- responce onsuccess: refillSummary, http status code: "+statusCode+" Byte responce: "+response);
			...
			public void onFailure(int statusCode, Header[] headers, byte[] errorResponse, Throwable e) {
				...
				try {
					...
					DATA.print("--onfail refillSummary: " +content);
	...
	ArrayList<DrugBean> drugBeans;
	 ...
	 EditText editText;
		...
		public void sendRefillResponse(String status,String drug_id,String start_date,String end_date,String refill_id,
			...
			DATA.print("-- params in sendRefillResponse: "+params.toString());
			...
			client.post(DATA.baseUrl+"sendRefillResponse", params, new AsyncHttpResponseHandler() {
				...
				public void onSuccess(int statusCode, Header[] headers, byte[] response) {
					...
					try{
						...
						e.printStackTrace();
						DATA.print("-- responce onsuccess: sendRefillResponse, http status code: "+statusCode+" Byte responce: "+response);
						customToast.showToast(DATA.CMN_ERR_MSG,0,0);
					}
				}
				...
				public void onFailure(int statusCode, Header[] headers, byte[] errorResponse, Throwable e) {
					...
					try {
						String content = new String(errorResponse);
						DATA.print("--onfail sendRefillResponse " +content);
						new GloabalMethods(activity).checkLogin(content);
						customToast.showToast(DATA.CMN_ERR_MSG,0,0);
