...
import com.app.mhcsn_spe.permission.PermissionsActivity;
import com.app.mhcsn_spe.permission.PermissionsChecker;
...
public class Login extends AppCompatActivity implements ApiCallBack{
	...
	public static final String CURRENT_APP = "reliance_specialist";//by zohaib for urgent care doc
	public static final String HOSPITAL_ID_EMCURA = "17";//Reliance hosp id
