...
import com.app.mhcsn_spe.adapter.CategoriesAdapter;
import com.app.mhcsn_spe.api.ApiCallBack;
import com.app.mhcsn_spe.api.ApiManager;
import com.app.mhcsn_spe.model.CategoriesModel;
import com.app.mhcsn_spe.reliance.therapist.ActivityReferedPatients;
import com.app.mhcsn_spe.services.GPSTracker;
import com.app.mhcsn_spe.util.ActionEditText;
import com.app.mhcsn_spe.util.CallWebService;
...
public class MainActivityNew extends AppCompatActivity implements ApiCallBack, GloabalSocket.SocketEmitterCallBack{
	...
	TextView  tvAppointments, tvDrProfile, tvLogout,tvDrSchedule,
			...
			tvRatting,tvRefills,tvTCM,tvBilling,tvSupport,tvGroups,tvAddDoctor,tvEMS,tvSoapRef,tvMyPatients,tvRefferedPatients,
			tvInstantConnect,tvAppInvite,tvReffredPt,tvRefrals;
...
//		exportDB();
		...
		tvRefferedPatients = findViewById(R.id.tvRefferedPatients);
		...
		tvRefferedPatients.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
