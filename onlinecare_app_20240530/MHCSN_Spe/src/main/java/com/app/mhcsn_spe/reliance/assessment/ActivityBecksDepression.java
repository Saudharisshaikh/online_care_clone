...
import com.app.mhcsn_spe.adapter.LvBeckDepAdapter;
import com.app.mhcsn_spe.api.ApiManager;
import com.app.mhcsn_spe.model.BDBean;
...
public class ActivityBecksDepression extends BaseActivity {
    ...
    public void loadForm(){
        String cachedForm = sharedPrefsHelper.get("becks_dep_form_json", "");
        if(! cachedForm.isEmpty()){
            ApiManager.shouldShowPD = false;
            parseData(cachedForm);
        }
    ...
    public void submitDepSurvey(){
        ...
        for (int i = 0; i < bdBeans.size(); i++) {
                    ...
                    answer[2]=2
                    answer[3]=2*/
            System.out.println("answer["+i+"]"   + " = "  + bdBeans.get(i).score);
    ...
    public void parseData(String jsonStr){
        try {
            ...
            sharedPrefsHelper.save("becks_dep_form_json", jsonStr);
    ...
    public void sumUpScore(){
        ...
        for (int i = 0; i < bdBeans.size(); i++) {
            ...
            //System.out.println("-- Index : "+i+" isGroupSelected: "+bdBeans.get(i).isGroupSelected+" checkedRadio: "+bdBeans.get(i).seletedRadioIndex);
        }
