...
import com.app.mhcsn_spe.adapter.LvDoctorsAdapter;
import com.app.mhcsn_spe.adapter.NurseAdapter;
import com.app.mhcsn_spe.api.ApiManager;
import com.app.mhcsn_spe.fcm.MyFirebaseMessagingService;
import com.app.mhcsn_spe.model.DoctorsModel;
import com.app.mhcsn_spe.model.NurseBean;
    ...
    public void initVideoCallActivity(){
        ...
        callConnectBroadcast = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                Toast.makeText(context, "Connected Push", Toast.LENGTH_SHORT).show();
            }
        };
