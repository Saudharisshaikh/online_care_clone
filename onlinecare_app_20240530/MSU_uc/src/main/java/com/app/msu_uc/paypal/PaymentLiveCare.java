...
import com.app.msu_uc.util.LiveCareInsuranceCardhelper;
import com.app.msu_uc.util.LiveCareInsuranceInterface;
...
/*	private static PayPalConfiguration config = new PayPalConfiguration()
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//Note : GM moved these calls to home/to fix APT issue - 30 nov 2021
		/*if (checkInternetConnection.isConnectedToInternet()){
			//getPayers();
			getPackageAmount();
			paymentCredentials();
		...
		tvCrediCardAmount.setText("Payment Amount $"+sharedPrefsHelper.get(SharedPrefsHelper.PKG_AMOUNT, "5"));
