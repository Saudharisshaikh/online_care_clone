...
import com.app.msu_uc.model.DrInfoBean;
		...
		client.get(DATA.baseUrl+"/doctorInfo/"+doctorId, new AsyncHttpResponseHandler() {
			...
			public void onSuccess(int statusCode, Header[] headers, byte[] response) {
				...
				try{
					...
					DATA.print("--responce in doctorInfo: "+content);
					...
					e.printStackTrace();
					DATA.print("-- responce onsuccess: doctorInfo , http status code: "+statusCode+" Byte responce: "+response);
			...
			public void onFailure(int statusCode, Header[] headers, byte[] errorResponse, Throwable e) {
				...
				try {
					...
					DATA.print("--responce in failure doctorInfo: "+content);
