...
public class Login extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, ApiCallBack {
    ...
    public static final String CURRENT_APP = "msu_patient",
            HOSP_ID_PREFS_KEY = "hospital_id_from_servicve";
    String hospitalIdLogin = "50";

    public static String HOSPITAL_ID_EMCURA = "50";//Reliance hosp id
    ...
    protected void onResume() {
        ...
        //Ahmer code
        getHospitalDataById(prefs.getString("hospitalIdLogin", "50"));
            ...
            try {
                ...
                if (status.equals("success")) {
                    ...
                    if (user_info.getString("is_approved").equalsIgnoreCase("0")) {
                        ...
                        ed.putString("folder_name", user_info.optString("folder_name"));
...
-- Request code: 64206 result code: -1 intentData: Intent { (has extras) }   facebook logged in*/
    ...
    private void getHospitalDataById(String hospitalID) {
        ...
        DATA.print("-- RequestUrl in getHospitalDataById " + RequestUrl);
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                try {
                    ...
                    if (jsonObj.has("folder_name")) {
                        SharedPreferences.Editor ed = prefs.edit();
                        ed.putString("folder_name", jsonObj.optString("folder_name"));
                        ed.commit();
                    }
