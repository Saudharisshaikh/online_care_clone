...
import com.app.msu_uc.util.UriUtilGM;
...
import static com.app.msu_uc.util.ActionSheetPopup.REQUEST_SELECT_FROM_GALLERY_LIVECARE;
import static com.app.msu_uc.util.SharedPrefsHelper.PKG_AMOUNT;
...
public class GetLiveCare extends BaseActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(getSupportActionBar() != null){
			getSupportActionBar().setTitle("Clinical Care");
		...
		ArrayAdapter<SymptomsModel> symptomAdapter = new ArrayAdapter<>(activity, R.layout.listitem_singlechoice_new, android.R.id.text1, symptomsModels);
		//ArrayAdapter<ConditionsModel> conditionsAdapter = new ArrayAdapter<>(activity, android.R.layout.simple_list_item_single_choice, android.R.id.text1, conditionsModels);
