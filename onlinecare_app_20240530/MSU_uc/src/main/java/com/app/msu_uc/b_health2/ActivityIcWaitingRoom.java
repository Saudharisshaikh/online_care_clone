		...
		if(apiName.contains(ApiManager.BHEALTH_GET_WAITING_PATIENTS)){
			...
			try {
				...
				if(jsonObject.getString("status").equalsIgnoreCase("success")){
                    ...
                    tvWaitMsgDocInfo.setText(message);

                    if(GetLiveCareFormBhealth.activityGetLiveCareFormBhealth != null){
                    	try {
                    		GetLiveCareFormBhealth.activityGetLiveCareFormBhealth.finish();
