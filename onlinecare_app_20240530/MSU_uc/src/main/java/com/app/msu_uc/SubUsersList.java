...
import com.app.msu_uc.adapter.SubUsersAdapter;
...
public class SubUsersList  extends BaseActivity {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
                ...
                if(position == 0 && !isFromHome){
                    ...
                    try {
                        ...
                        DATA.print("-- diff years: "+diffYears);
    ...
    public void displaySubUsersList(String content){
        ...
        int clickPos = 0;
        lvSubUsersList.performItemClick(lvSubUsersList.getAdapter().getView(clickPos, null, null),
                clickPos, lvSubUsersList.getAdapter().getItemId(clickPos));
    }
