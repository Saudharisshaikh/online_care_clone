...
import com.app.msu_uc.model.PayerBean;
...
public class BookAppointment extends BaseActivity {
	...
	protected void onResume() {
		...
		if(PaymentLiveCare.isBraintreePaymentDone){
			bookAppointmentCall();
		}
	}
			...
			public void onClick(View v) {
				...
				builder.setPositiveButton("Yes, confirm", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						DATA.print("-- gmgm - "+DATA.selectedRGFreePaypal);
						...
						}else if (DATA.selectedRGFreePaypal.equals("credit_card")){
