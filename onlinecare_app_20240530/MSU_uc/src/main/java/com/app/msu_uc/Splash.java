...
public class Splash extends Activity {
	...
	TextView tvSplashContinue,tvSplashCAllninonon,tvSplashCAllnine88;
...
//	loginToQB();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tvSplashCAllnine88 = (TextView) findViewById(R.id.tvSplashCAllnine88);
		...
		tvSplashCAllnine88.setOnClickListener(new OnClickListener() {
