...
import com.app.onlinecare_dr_pk.adapter.LabReportsAdapter;
import com.app.onlinecare_dr_pk.adapter.TelemedicineAdapter;
import com.app.onlinecare_dr_pk.adapter.TelemedicineAdapter2;
import com.app.onlinecare_dr_pk.api.ApiManager;
import com.app.onlinecare_dr_pk.model.LabReportBean;
import com.app.onlinecare_dr_pk.model.TelemedicineCatData;
import com.app.onlinecare_dr_pk.model.TelemedicineCategories;
import com.app.onlinecare_dr_pk.model.TimeDiff;
import com.app.onlinecare_dr_pk.reliance.DialogAllEncNotes;
...
import com.app.onlinecare_dr_pk.util.PrescriptionModule;
...
//		params.put("appointment_id", DATA.selectedUserAppntID);
	...
	public void showTelemedicineDialog(){
		...
		//getTelemedicineServices();
		btnUseForBillingNo.performClick();
	}
