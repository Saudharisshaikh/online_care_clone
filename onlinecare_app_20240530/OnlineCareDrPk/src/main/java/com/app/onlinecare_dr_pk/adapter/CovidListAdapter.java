...
import com.app.onlinecare_dr_pk.ActivityCovidFormList;
...
public class CovidListAdapter extends ArrayAdapter<CovidFormListBean> {
    ...
    static class ViewHolder {
        TextView tvPatientName, tvDate, tvViewForm,tvAction, tvCareAct, tvCall, tvMessage,tvResultStatus,tvSendResults,tvTestLocation,tvAddVitals;//tvAssignToProvider,tvCheckedBy
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.tvCulture.setText(covidFormListBeans.get(position).culture.equalsIgnoreCase("1") ? "Culture : Yes" : "Culture : No");
