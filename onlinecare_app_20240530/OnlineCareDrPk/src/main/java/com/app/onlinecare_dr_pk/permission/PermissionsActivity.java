package com.app.onlinecare_dr_pk.permission;
...
public class PermissionsActivity extends AppCompatActivity {
    ...
    private void requestPermissions(String... permissions) {
        ...
        if(prefs.getBoolean("isFirstTimeRequest",true)){
            ...
            for (int i = 0; i < permissions.length; i++) {
                ...
                DATA.print("permission: "+permissions[i]+"  shouldshowrationale: "+ ActivityCompat.shouldShowRequestPermissionRationale(activity,permissions[i]));
    ...
    final int REQ_CODE_APPEARONTOP = 1910;
    private void allPermissionsGranted() {
        ...
        /*if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.M){
            if (!Settings.canDrawOverlays(this)) {
                ...
                startActivityForResult(intent, REQ_CODE_APPEARONTOP);
            }else {
                finish();
            }
        } else{
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        DATA.print("Reqcode : "+requestCode+ "result code : "+resultCode+" Intent: "+data);
    }*/
