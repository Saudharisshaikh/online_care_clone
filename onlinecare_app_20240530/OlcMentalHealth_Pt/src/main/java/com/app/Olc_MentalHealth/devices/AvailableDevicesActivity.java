...
import com.app.Olc_MentalHealth.devices.adapters.AvailableDevicesAdapter;
...
import com.app.Olc_MentalHealth.devices.parsers.AllDevicesParser;
...
//                new StaggeredGridLayoutManager(2, StaggeredGridLayoutManager.GAP_HANDLING_MOVE_ITEMS_BETWEEN_SPANS);
    ...
    private void generateAndCallAuthorize() {
        ...
        try {
            signature = CustomMethods.generateHmacSHA1(base1, CommonConstants.withingsCustomerSecret + "&" + lsp.getWithingsBpOauthTokenSecret());
    ...
    private void authenticateWithingsBloodPressureDevice() {
        ...
        try {
            signature = CustomMethods.generateHmacSHA1(base1, CommonConstants.withingsCustomerSecret + "&");
