...
//    private String publishableKey = "pk_test_feMthKa2uLqJraWrVFIDaR9j";//Junaid Amin
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        *//*PaymentConfiguration.init(getApplicationContext(), publishableKey);
        DATA.print("-- pulishable key : "+PaymentConfiguration.getInstance(getApplicationContext()).getPublishableKey());
        ...
        *//*Button btn_StripeGM = findViewById(R.id.btn_StripeGM);
        btn_StripeGM.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //=======================================================================
                //DATA.print("cardno: "+card_number+" exp month: "+ Integer.parseInt(Expiremonth)+" exp year: "+ Integer.parseInt(Expireyear)+" cvv: "+ Cvv2);
    ...
    final int CARD_IO_REQUEST_CODE = 1219;
    @Override
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CARD_IO_REQUEST_CODE) {
            DATA.print("-- result code "+requestCode+"  DATA = "+ data);
            Bundle bundle = data.getExtras();
            if (bundle != null) {
                for (String key : bundle.keySet()) {
                    DATA.print( "-- Scan Card Result : "+key + " : " + (bundle.get(key) != null ? bundle.get(key) : "NULL"));
                }
                io.card.payment.CreditCard  o = (CreditCard) bundle.get("io.card.payment.scanResult");
                DATA.print(o.cardholderName + " , "+o.cardNumber +" , "+o.expiryMonth +" , "+o.expiryMonth + " , "+o.cvv);
            }
        }
    }
    ...
    private static final class PaymentResultCallback implements ApiResultCallback<PaymentIntentResult> {
        ...
        public void onSuccess(@NonNull PaymentIntentResult result) {
            ...
            if (status == PaymentIntent.Status.Succeeded) {
                ...
                DATA.print("--Payment completed"+gson.toJson(paymentIntent));
                ...
                //DATA.print("--Payment failed"+Objects.requireNonNull(paymentIntent.getLastPaymentError()).getMessage());
            }
        }
