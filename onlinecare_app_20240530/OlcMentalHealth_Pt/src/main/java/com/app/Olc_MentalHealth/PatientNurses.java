...
import com.app.Olc_MentalHealth.adapter.NurseAdapter;
import com.app.Olc_MentalHealth.api.ApiManager;
import com.app.Olc_MentalHealth.model.NurseBean;
        ...
        client.post(DATA.baseUrl+"patientNurses", params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] response) {
                ...
                try{
                    ...
                    DATA.print("--reaponce in patientNurses: "+content);
                    ...
                    e.printStackTrace();
                    DATA.print("-- responce onsuccess: patientNurses, http status code: "+statusCode+" Byte responce: "+response);
            ...
            public void onFailure(int statusCode, Header[] headers, byte[] errorResponse, Throwable e) {
                ...
                try {
                    ...
                    DATA.print("--onfail patientNurses: " +content);
