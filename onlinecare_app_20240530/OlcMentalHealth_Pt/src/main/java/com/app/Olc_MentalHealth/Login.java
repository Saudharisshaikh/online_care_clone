...
public class Login extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, ApiCallBack {
	...
	public static final String CURRENT_APP = "mh_patient",
			HOSP_ID_PREFS_KEY = "hospital_id_from_servicve";
	public static String hospitalIdLogin = "51";

	public static String HOSPITAL_ID_EMCURA = "51";//1 Onlinecare US hosp id
