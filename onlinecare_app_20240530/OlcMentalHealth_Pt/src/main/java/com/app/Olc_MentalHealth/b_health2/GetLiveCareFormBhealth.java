...
import com.app.Olc_MentalHealth.GetLiveCare;
import com.app.Olc_MentalHealth.Login;
import com.app.Olc_MentalHealth.SearchADoctor;
...
import com.app.Olc_MentalHealth.ActivityUrgentCareDoc;
import com.app.Olc_MentalHealth.BaseActivity;
import com.app.Olc_MentalHealth.R;
import com.app.Olc_MentalHealth.SelectReports;
import com.app.Olc_MentalHealth.adapter.RvBodyPartAdapter;
import com.app.Olc_MentalHealth.adapter.RvPainAdapter;
import com.app.Olc_MentalHealth.adapter.VVReportImagesAdapter;
...
import com.app.Olc_MentalHealth.util.ActionSheetPopup;
...
import com.app.Olc_MentalHealth.util.RecyclerItemClickListener;
...
import static com.app.Olc_MentalHealth.GetLiveCare.bodyParts;
...
public class GetLiveCareFormBhealth extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                ArrayAdapter<ConditionsModel> conditionsAdapter = new ArrayAdapter<ConditionsModel>(activity, R.layout.listitem_singlechoice, android.R.id.text1, conditionsModels) {
                    ...
                    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
                        ...
                        DATA.print("-- conditionName : " + conditionsModels.get(position).conditionName);
                        ...
                        } else if (conditionsModels.get(position).conditionName.equalsIgnoreCase("Insomnia")) {
                            drawableResource = R.drawable.ic_insomnia;
                        } /*else if (conditionsModels.get(position).conditionName.equalsIgnoreCase("Addictions")) {
                            drawableResource = R.drawable.ic_insomnia;
                        } else if (conditionsModels.get(position).conditionName.equalsIgnoreCase("Bipolar Disorder")) {
                            drawableResource = R.drawable.ic_insomnia;
                        }*/ else {
                            drawableResource = R.drawable.ic_others;
                        }
        ...
        int vis = isFromEmowellClick ? View.GONE : View.GONE;
