package com.app.Olc_MentalHealth.devices;
...
import com.app.Olc_MentalHealth.devices.adapters.MyDevicesAdapter1;
import com.app.Olc_MentalHealth.devices.asynctasks.FetchData;
import com.app.Olc_MentalHealth.devices.asynctasks.PostData;
import com.app.Olc_MentalHealth.devices.beanclasses.BpHeartRateValuesBean;
import com.app.Olc_MentalHealth.devices.beanclasses.DeviceBean;
import com.app.Olc_MentalHealth.devices.customclasses.CommonConstants;
import com.app.Olc_MentalHealth.devices.customclasses.CustomMethods;
import com.app.Olc_MentalHealth.devices.customclasses.LocalSharedPreferences;
import com.app.Olc_MentalHealth.devices.customclasses.SessionIdentifierGenerator;
import com.app.Olc_MentalHealth.devices.interfaces.FetchDataCallbackInterface;
import com.app.Olc_MentalHealth.devices.parsers.MyDevicesParser;
import com.app.Olc_MentalHealth.devices.parsers.WithingsBpDeviceParser;
...
public class MyDevices extends AppCompatActivity implements FetchDataCallbackInterface {
    ...
    public void getUserMeasures(DeviceBean myDevice, boolean isDateRangeSelected) {
        ...
        try {
            signature = CustomMethods.generateHmacSHA1(base1, CommonConstants.withingsCustomerSecret + "&" + myDevice.getoAuthSecret());
            ...
            String url = CommonConstants.withingsGetMeasuresUrl +
                    ...
                    "&oauth_signature="+ CustomMethods.enc(signature)+
    ...
    public static class DatePickerFragment extends DialogFragment
        ...
        public void onDateSet(DatePicker view, int year, int month, int day)
        {
            ...
            try {
                ...
                DATA.print("Date in milli :: " + timeInMilliseconds);
