...
import com.app.onlinecare_pk.util.ChoosePictureDialog;
...
import com.app.onlinecare_pk.util.UploadImageCall;
...
public class UpdateProfile extends BaseActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		etUpdateProfileCountry.setText("Pakistan");
		...
		spStateAdapter.setDropDownViewResource(R.layout.spinner_item);//android.R.layout.simple_spinner_dropdown_item
