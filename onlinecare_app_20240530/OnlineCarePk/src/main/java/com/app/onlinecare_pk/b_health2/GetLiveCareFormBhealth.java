...
import com.app.onlinecare_pk.SearchADoctor;
import com.app.onlinecare_pk.SelectReports;
import com.app.onlinecare_pk.adapter.RvBodyPartAdapter;
import com.app.onlinecare_pk.adapter.RvPainAdapter;
import com.app.onlinecare_pk.adapter.VVReportImagesAdapter;
...
import com.app.onlinecare_pk.util.ActionSheetPopup;
...
import com.app.onlinecare_pk.util.Database;
...
import com.app.onlinecare_pk.util.SharedPrefsHelper;
...
public class GetLiveCareFormBhealth extends BaseActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                try {
                    ...
                    if(gvConditionNew.isItemChecked(position)){
                        if(condName.contains("Depression Analysis")){
                            /*GloabalMethods.isFromGetLiveCare = true;
                            ActivityPHQ_Form.formFlag = 1;
                            openActivity.open(ActivityPHQ_Form.class, false);*/
                            assessmentsAdded.add(condName);
                        }else if(condName.contains("Anxiety Health")){
                            /*GloabalMethods.isFromGetLiveCare = true;
                            ActivityPHQ_Form.formFlag = 2;
                            //dialogOptions.dismiss();
                            openActivity.open(ActivityPHQ_Form.class, false);*/
                            assessmentsAdded.add(condName);
                        }else if(condName.contains("Substance Abuse")){//DAST
                            /*GloabalMethods.isFromGetLiveCare = true;
                            openActivity.open(ActivityDAST_Form.class, false);*/
                            assessmentsAdded.add(condName);
                        }else if(condName.contains("Stress")){
                            /*GloabalMethods.isFromGetLiveCare = true;
                            ActivityOCD_Form.formFlag = 5;//mo need to assign as activity seperite, but double check purpose
                            openActivity.open(ActivityStressQues_Form.class, false);*/
                            assessmentsAdded.add(condName);
                        }else if(condName.contains("Eating Disorder")){//SCOFF
                            /*GloabalMethods.isFromGetLiveCare = true;
                            ActivityOCD_Form.formFlag = 4;
                            openActivity.open(ActivityOCD_Form.class, false);*/
                            assessmentsAdded.add(condName);
                        }else if(condName.contains("Panic Attack")){
                            /*GloabalMethods.isFromGetLiveCare = true;
                            ActivityOCD_Form.formFlag = 3;
                            openActivity.open(ActivityOCD_Form.class, false);*/
                            assessmentsAdded.add(condName);
                        }else if(condName.contains("Insomnia")){
                            //under development
                        }else if(condName.contains("OCD")){
                            /*GloabalMethods.isFromGetLiveCare = true;
                            ActivityOCD_Form.formFlag = 1;
                            openActivity.open(ActivityOCD_Form.class, false);*/
                            assessmentsAdded.add(condName);
                        }else if(condName.contains("Focus Concentration")){
                            /*GloabalMethods.isFromGetLiveCare = true;
                            ActivityOCD_Form.formFlag = 2;
                            openActivity.open(ActivityOCD_Form.class, false);*/
                            assessmentsAdded.add(condName);
        ...
        int vis = isFromEmowellClick ? View.INVISIBLE : View.VISIBLE;
