 ...
 * Call {@link SpinnerSpinnerCustom#programmaticallySetPosition} to use this feature.
 * Created by vedant on 6/1/15.
 */
public class SpinnerCustom extends androidx.appcompat.widget.AppCompatSpinner implements AdapterView.OnItemSelectedListener {
     ...
     */
    private boolean mUserActionOnSpinner = false;//gm changed initial value to false to restrict call for 1st time when set adapter
    ...
    public SpinnerCustom(Context context, int mode) {
        super(context, mode);
        super.setOnItemSelectedListener(this);
    }
    ...
    public SpinnerCustom(Context context, AttributeSet attrs, int defStyle, int mode) {
