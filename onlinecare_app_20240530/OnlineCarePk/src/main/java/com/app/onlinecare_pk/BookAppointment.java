...
import com.app.onlinecare_pk.util.LiveCareInsuranceCardhelper;
import com.app.onlinecare_pk.util.LiveCareInsuranceInterface;
...
public class BookAppointment extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
			...
			public void onCheckedChanged(RadioGroup group, int checkedId) {
				...
				switch (checkedId) {
					...
					case R.id.radioFreeCare:
						...
						layFreeOptions.setVisibility(View.GONE);//VISIBLE - PK app direct
						//insuranceCont.setVisibility(View.GONE);
						layCreditCard.setVisibility(View.GONE);
						//payment_typeIC = "";
						btnBKAccept.setVisibility(View.VISIBLE);//GONE - - PK app direct
		...
		rgPayment.check(R.id.radioFreeCare);
