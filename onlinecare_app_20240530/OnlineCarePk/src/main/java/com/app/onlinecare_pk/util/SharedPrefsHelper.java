...
public class SharedPrefsHelper {
    ...
    private SharedPrefsHelper() {
        ...
        sharedPreferences = OnlineCare.getInstance().getSharedPreferences(SHARED_PREFS_NAME, Context.MODE_PRIVATE);
        DATA.print("--App instance in prefshelper: "+ OnlineCare.getInstance());
    }
