...
public class Login extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, ApiCallBack{
	...
	public static final String CURRENT_APP = "patient_pk",
	HOSP_ID_PREFS_KEY = "hospital_id_from_servicve";

	public static String HOSPITAL_ID_EMCURA = "1";//Emcura hosp id
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tvLoginForgotPass.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				openActivity.open(ForgotPassword2.class, false);
			}
		});
...
/*		rgOptions.setOnCheckedChangeListener(new OnCheckedChangeListener() {
		...
		btnSignup.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				openActivity.open(Signup2.class, false);
			}
		});
		...
		btnLogin.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				&& etLoginPassword.getText().toString().trim().equalsIgnoreCase("olc12345")){
					...
					onResume();
				} else if(etLoginUsername.getText().toString().trim().equalsIgnoreCase("12345678")
						&& etLoginPassword.getText().toString().trim().equalsIgnoreCase("12345678")) {
...
//							}
					...
					DATA.baseUrl = DATA.ROOT_Url+DATA.POST_FIX;//For PK apps only
					getOAuthToken();
