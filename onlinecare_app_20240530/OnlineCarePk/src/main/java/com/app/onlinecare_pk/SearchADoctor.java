...
import com.app.onlinecare_pk.util.DatePickerFragment2;
...
import static com.app.onlinecare_pk.GetLiveCare.painSeverity;
		...
		btnSbmtSymptom.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(apptmntDate.isEmpty()) {
					...
					DoctorsList.zipcodeForApptmnt = "48503";//etZipCode.getText().toString();
