...
public class MyAppointmentsModel {
	...
	public boolean isFiveMinuteFromNow;
	...
	public MyAppointmentsModel(String appointment_id, String appointment_date,
							   ...
							   String date,String slot_id,String reason,String doctor_category, boolean isFiveMinuteFromNow) {
		super();
		...
		this.isFiveMinuteFromNow = isFiveMinuteFromNow;
	}
