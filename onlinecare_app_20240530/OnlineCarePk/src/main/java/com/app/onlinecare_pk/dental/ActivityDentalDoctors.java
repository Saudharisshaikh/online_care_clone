...
import com.app.onlinecare_pk.adapter.LvLivecareDoctorsAdapter;
import com.app.onlinecare_pk.adapter.NearbyHospitalsAdapter;
import com.app.onlinecare_pk.api.ApiManager;
import com.app.onlinecare_pk.model.HospitalsBean;
import com.app.onlinecare_pk.model.NearbyDoctorBean;
...
public class ActivityDentalDoctors extends AppCompatActivity {
	...
	LvDentalDoctorsAdapter lvDentalDoctorsAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_dental_doctors);
		...
		activity = ActivityDentalDoctors.this;
		...
		etSearchDoc.addTextChangedListener(new TextWatcher() {
			...
			public void afterTextChanged(Editable s) {
				if(lvDentalDoctorsAdapter != null){
					lvDentalDoctorsAdapter.filter(s.toString());
				}
			}
		});
				...
				try{
					...
					try {
						...
						if (data.length() == 0) {
							...
							lvDentalDoctorsAdapter = new LvDentalDoctorsAdapter(activity, latLongBeansList);
							lvDoctors.setAdapter(lvDentalDoctorsAdapter);
