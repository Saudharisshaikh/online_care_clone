package com.app.onlinecare_pk.api;
...
import static com.app.onlinecare_pk.util.DATA.SIGNUP_URL;
import static com.app.onlinecare_pk.util.DATA.baseUrl;
...
public class ApiManager {
	...
	public static final String PATIENT_LOGIN = "patient/login";//"patients/login"//For pk apps
	...
	//Pk Apps APIs
	public static final String OTP_REQUEST = "otp_code/otp_request";
	public static final String OTP_VERIFY = "otp_code/verifyOtp";
	public static final String PATIENT_SIGNUP_PK = "patient/patientSignup";
	public static final String OTP_REQUEST_PASSWORD_PK = "otp_code/otp_request_password";
	public static final String FORGOT_PASSWORD_PK = "patient/forgotPassword";
