...
import com.app.onlinecare_pk.OnlineCare;
...
import com.app.onlinecare_pk.languagebeans.HomeScreenItem;
import com.app.onlinecare_pk.model.CategoriesModel;
import com.app.onlinecare_pk.model.ConditionsModel;
import com.app.onlinecare_pk.model.ConversationBean;
import com.app.onlinecare_pk.model.CountryBean;
import com.app.onlinecare_pk.model.DoctorsModel;
import com.app.onlinecare_pk.model.MyAppointmentsModel;
import com.app.onlinecare_pk.model.PastHistoryBean;
import com.app.onlinecare_pk.model.RelativeHadBean;
import com.app.onlinecare_pk.model.ReportsModel;
import com.app.onlinecare_pk.model.SpecialityModel;
import com.app.onlinecare_pk.model.StateBean;
...
public class DATA {
	...
	public static final String SIGNUP_URL = ROOT_Url + "pk/index.php/app/";//For PK apps only
	//public static final String POST_FIX = "/index.php/app/";
	public static final String POST_FIX = "pk/index.php/app/";//For PK apps only

	public static final String APP_THEME_RED_COLOR = "#E24319";
...
//	}
	...
	public static void addIntent(Activity activity){
		...
		String url = "https://onlinecare.com/pk/";
