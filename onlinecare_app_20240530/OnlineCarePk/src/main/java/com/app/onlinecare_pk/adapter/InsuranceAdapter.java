...
//		filter(DATA.selectedDrId);
	...
	static class ViewHolder {
		...
		ImageView ivDeleteInsurance, ivICfrontImg,ivICBackImg,ivIDfrontImg,ivIDbackImg;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null) {
			...
			viewHolder.ivICfrontImg = convertView.findViewById(R.id.ivICfrontImg);
			viewHolder.ivICBackImg = convertView.findViewById(R.id.ivICBackImg);
			viewHolder.ivIDfrontImg = convertView.findViewById(R.id.ivIDfrontImg);
			viewHolder.ivIDbackImg = convertView.findViewById(R.id.ivIDbackImg);
			...
			convertView.setTag(R.id.ivICfrontImg, viewHolder.ivICfrontImg);
			convertView.setTag(R.id.ivICBackImg, viewHolder.ivICBackImg);
			convertView.setTag(R.id.ivIDfrontImg, viewHolder.ivIDfrontImg);
			convertView.setTag(R.id.ivIDbackImg, viewHolder.ivIDbackImg);
		} else {
		...
		DATA.print("-- prefs: "+prefs.getString("insurance","")+"  list val: "+myInsuranceBeens.get(position).insurance);



		DATA.loadImageFromURL(myInsuranceBeens.get(position).inc_front, R.drawable.ic_placeholder_2, viewHolder.ivICfrontImg );
		DATA.loadImageFromURL(myInsuranceBeens.get(position).inc_back, R.drawable.ic_placeholder_2, viewHolder.ivICBackImg);
		DATA.loadImageFromURL(myInsuranceBeens.get(position).id_front, R.drawable.ic_placeholder_2, viewHolder.ivIDfrontImg);
		DATA.loadImageFromURL(myInsuranceBeens.get(position).id_back, R.drawable.ic_placeholder_2, viewHolder.ivIDbackImg);
