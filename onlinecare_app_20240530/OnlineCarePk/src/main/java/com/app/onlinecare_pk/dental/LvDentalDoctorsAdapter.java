...
import com.app.onlinecare_pk.ActivityDoctorInfo;
import com.app.onlinecare_pk.ActivityUrgentCareDoc;
import com.app.onlinecare_pk.MapActivity;
...
public class LvDentalDoctorsAdapter extends ArrayAdapter<NearbyDoctorBean> {
	...
	public LvDentalDoctorsAdapter(Activity activity , ArrayList<NearbyDoctorBean> allLatlongs) {
		super(activity, R.layout.lv_dental_doctors_row, allLatlongs);
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null) {
			...
			convertView = layoutInflater.inflate(R.layout.lv_dental_doctors_row, null);
		...
		viewHolder.btnRequest.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				ActivityDentalCareForm.callAPI = true;
